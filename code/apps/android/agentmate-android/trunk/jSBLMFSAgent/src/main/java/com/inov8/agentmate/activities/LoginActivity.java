...
public class LoginActivity extends BaseCommunicationActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        strUniqueDeivceID = Settings.Secure.getString(LoginActivity.this.getContentResolver(), Settings.Secure.ANDROID_ID);
        ApplicationData.deviceId = strUniqueDeivceID;

        lblVersion.setText("App Version: " + Constants.APPLICATION_VERSION);

        String user = PreferenceConnector.readString(this, PreferenceConnector.USER_ID, "");
        if (user.length() > 0) {
        ...
        try {
            ...
            if (table.containsKey(Constants.KEY_LIST_MSGS)) {
                ...
                if (message.getCode().equals(
                    ...
                    Dialog mDialog = PopupDialogs.otpPopupDialog(message.getCode(),
                            message.getDescr(), PopupDialogs.Status.LOCK, LoginActivity.this,
                            new PopupDialogs.OnCustomClickListener() {
                    ...
                    btnResend = mDialog.findViewById(R.id.btnResend);
    ...
    private void timerCall() {
        ...
        isOtpResend=false;
       countDownTimer = new CountDownTimer(Constants.OTP_RESEND_TIMER, 1000) { //Set Timer for 5 seconds
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_PERMISSIONS: {
                ...
                if (grantResults.length > 0) {
                    ...
                    } else if (grantResults[3] == PackageManager.PERMISSION_GRANTED && permissions[3].equals(Manifest.permission.READ_CONTACTS)) {
