...
import com.inov8.agentmate.activities.exciseAndTaxation.ExciseAndTaxationInputActivity;
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (flowId) {
                    ...
                    case Constants.FLOW_ID_PROOF_OF_LIFE:
                        intent = new Intent(SubMenuAcitivity.this,
                                ProofOfLifeInputActivity.class);
                        break;
                    ...
                    case Constants.FLOW_ID_EXCISE_AND_TAXATION:
                        intent = new Intent(SubMenuAcitivity.this,
                                ExciseAndTaxationInputActivity.class);
                        break;
                    ...
                    case Constants.FLOW_ID_BOP_CASH_OUT:
                    case Constants.FLOW_ID_BOP_CASH_OUT_BY_CNIC:
                        intent = new Intent(SubMenuAcitivity.this,
                ...
                if (intent != null) {
                    ...
                    if (product.getId().equals(Constants.PRODUCT_ID_3RD_PARTY_CASH_OUT) && !android.os.Build.MODEL.equals("BH702G")) {
                        PopupDialogs.alertDialog("Transaction cannot be perform on this device.", PopupDialogs.Status.ALERT,
                                SubMenuAcitivity.this, (v, obj) -> {
                                });
                    } else {
