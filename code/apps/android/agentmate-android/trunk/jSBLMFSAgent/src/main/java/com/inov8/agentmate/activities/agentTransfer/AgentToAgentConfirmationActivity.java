...
public class AgentToAgentConfirmationActivity extends BaseCommunicationActivity implements MpinInterface{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			String labels[] = new String[] { "Receiver Mobile No.",
					"Receiver NIC", "Receiver Title", "Amount", "Charges",
					"Total Amount" };
			String data[] = new String[] { ramob, cnic,
					transactionInfo.getRaname(),
			...
			btnNext.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					askMpin(mBundle, TransactionReceiptActivity.class, false, AgentToAgentConfirmationActivity.this);
				}
			});
			...
			btnCancel.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					Utility.showConfirmationDialog(
							AgentToAgentConfirmationActivity.this,
	...
	public void processRequest() {
		...
		new HttpAsyncTask(AgentToAgentConfirmationActivity.this).execute(
				Constants.CMD_AGENT_TO_AGENT_TRANSFER + "", getEncryptedMpin(),
				product.getId(), transactionInfo.getRamob(),
				ApplicationData.agentMobileNumber, transactionInfo.getTxam(),
