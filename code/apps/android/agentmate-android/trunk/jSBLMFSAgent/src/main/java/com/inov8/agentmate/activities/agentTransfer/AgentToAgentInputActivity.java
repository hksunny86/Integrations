...
public class AgentToAgentInputActivity extends BaseCommunicationActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			lblHeading.setText("Agent to Agent");

			lblField1 = (TextView) findViewById(R.id.lblField1);
			lblField1.setText("Agent Mobile Number");
			...
			btnNext.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
                    ...
                    if (input1 != null && (input1.getText().toString().charAt(0) != '0' || input1.getText().toString().charAt(1) != '3')) {
	...
	public void processRequest() {
		...
		new HttpAsyncTask(AgentToAgentInputActivity.this).execute(
				Constants.CMD_AGENT_TO_AGENT_TRANSFER_INFO + "",
				product.getId(), input1.getText().toString(),
				ApplicationData.agentMobileNumber, input2.getText().toString());
	}
		...
		try {
			...
			if (table != null && table.containsKey(Constants.KEY_LIST_ERRORS)) {
				...
				TransactionInfoModel transactionInfo = TransactionInfoModel
						.getInstance();
				transactionInfo.AgentTransfer(table.get(Constants.ATTR_RAMOB)
						.toString(), table.get(Constants.ATTR_RACNIC)
						.toString(), table.get(Constants.ATTR_RANAME)
				...
				Intent intent = new Intent(getApplicationContext(),
						AgentToAgentConfirmationActivity.class);
