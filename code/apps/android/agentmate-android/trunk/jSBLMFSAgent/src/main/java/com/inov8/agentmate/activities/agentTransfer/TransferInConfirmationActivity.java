...
public class TransferInConfirmationActivity extends BaseCommunicationActivity implements MpinInterface {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String labels[] = new String[]{"Agent Mobile No.", "To Account",
                    "From Account", "Amount", "Charges", "Total Amount"};
            String data[] = new String[]{senderMobileNumber, toAccount,
                    fromAccount, amount + Constants.CURRENCY,
            ...
            btnNext.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                    ...
                    askMpin(mBundle, TransactionReceiptActivity.class, false, TransferInConfirmationActivity.this);
                }
            });
            ...
            btnCancel.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Utility.showConfirmationDialog(
                            TransferInConfirmationActivity.this,
