...
public class TransferOutConfirmationActivity extends BaseCommunicationActivity implements MpinInterface{
        ...
        try {
            ...
            btnNext.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    askMpin(mBundle, TransactionReceiptActivity.class, false, TransferOutConfirmationActivity.this);
                }
            });
