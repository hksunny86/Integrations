...
//            case Constants.CMD_FUNDS_TRANSFER_CNIC2CNIC:
            ...
            case Constants.CMD_BOP_ISSUANCE_REISSUANCE:
            ...
            case Constants.CMD_KHIDMAT_CARD_CONFIRMATION:
            case Constants.CMD_L1_TO_HRA:
            case Constants.CMD_PROOF_OF_LIFE:
            ...
            case Constants.CMD_BOP_CASH_OUT:
                pin = params[1];
                break;
        }
            ...
            if (verifyPinFlag) {
                switch (command) {
                    ...
                    case Constants.CMD_SET_MPIN:
                        response = httpCall.setPin(command, params[1], params[2]);
                        break;
                    ...
                    case Constants.CMD_3RD_PARTY_CASH_OUT_INFO:
                        response = httpCall.thirdPartyCashOutInfo(command, params[1], params[2], params[3], params[4], params[5], params[6]);
                        break;

                    case Constants.CMD_PROOF_OF_LIFE_INFO:
                        response = httpCall.proofOfLifeInfo(command, params[1], params[2], params[3], params[4], params[5], params[6],
                                params[7], params[8]);
                        break;

                    case Constants.CMD_PROOF_OF_LIFE:
                        response = httpCall.proofOfLife(command, params[1], params[2], params[3], params[4], params[5], params[6],
                    ...
                    case Constants.CMD_3RD_PARTY_CASH_OUT:
                        response = httpCall.thirdPartyCashOut(command, params[1],
                                ...
                                params[14], params[15], params[16], params[17], params[18], params[19], params[20], params[21], params[22], params[23], params[24], params[25], params[26], params[27]);
                        break;

                    case Constants.CMD_BOP_CASH_OUT:
                        response = httpCall.BOPCashOut(command, params[1],
                                params[2], params[3], params[4], params[5],
                                params[6], params[7], params[8], params[9],
                                params[10], params[11], params[12], params[13], params[14], params[15], params[16], params[17]);
                        break;
                        case Constants.CMD_BOP_ISSUANCE_REISSUANCE:
                        response = httpCall.BOPCardIssuanceReIssuanceConform(command, params[1],
                                params[2], params[3], params[4], params[5],
                                params[6], params[7], params[8], params[9],
                                params[10], params[11], params[12]);
                        break;

                    case Constants.CMD_KHIDMAT_CARD_REGISTRATION:
                        response = httpCall.KhidmatCardRegistration(command, params[1], params[2], params[3], params[4]);
                        break;

                    case Constants.CMD_KHIDMAT_CARD_CONFIRMATION:
                        response = httpCall.KhidmatCardRegistrationConfirmation(command, params[1],
                    ...
                    case Constants.CMD_OPEN_ACCOUNT_VERIFY_CUSTOMER_REGISTRATION:
                        response = httpCall.openAccountVerifyCustomerRegistration(command,
                    ...
                    case Constants.CMD_DEBIT_CARD:
                        ...
                        break;
                    case Constants.CMD_DORMANCY:
                    case Constants.CMD_DORMANCY_CONFIRMATION:
                        response = httpCall
                                .dormancy(command, params[1], params[2]);
                        break;
                    ...
                    case Constants.CMD_EXCISE_AND_TAXATION_INFO:
                        response = httpCall.exciseAndTaxationInfo(command, params[1],
                                params[2], params[3], params[4]);
                        break;

                    case Constants.CMD_EXCISE_AND_TAXATION_PAYMENT:
                        response = httpCall.exciseAndTaxationPayment(command, params[1],
                                params[2], params[3], params[4], params[5], params[6]);
                        break;
                    ...
                    case Constants.CMD_BOP_CASH_OUT_INFO:
                        response = httpCall.BOPCashOutInfo(command, params[1],
                                params[2], params[3], params[4], params[5], params[6], params[7]);
                        break;

                    case Constants.CMD_BOP_ISSUANCE_REISSUANCE_INFO:
                        response = httpCall.BOPCardIssuanceReIssuance(command, params[1],
                                params[2], params[3], params[4], params[5], params[6], params[7], params[8], params[9]);
                        break;
                    ...
                    case Constants.CMD_FETCH_SEGMENTS:
                        response = httpCall.fetchSegments(command);
                        break;
                    case Constants.CMD_OPEN_ACCOUNT_FETCH_SEGMENTS:
                        response = httpCall.openAccountFetchSegments(command);
                        break;
                    case Constants.CMD_DEBIT_CARD_FETCH_SEGMENTS:
                        response = httpCall.fetchCardTypes(command);
                        break;
                    ...
                    case Constants.CMD_BVS_FAIL:
                        response = httpCall.agentBvsFailed(command, params[1]);
                        break;
