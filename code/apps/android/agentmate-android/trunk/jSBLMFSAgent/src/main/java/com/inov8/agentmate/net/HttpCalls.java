...
//                "        <param name=\"MAILING_ADDRESS\">"+mailingAddress+"</param>\n" +
    ...
    public HttpResponseModel dormancy(int command, String mobNO, String cnic) throws Exception {
    ...
    public HttpResponseModel debitCardRequestConfirmation(int command, String mobNO,
                                                          String cnic, String embossingName, String mailingAddress, String selectedCardType,
                                                          String agentId,String segmentId) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                "        <param name=\"CARD_DESCRIPTION\">" + embossingName + "</param>\n" +
                "        <param name=\"MAILING_ADDRESS\">" + mailingAddress + "</param>\n" +
                "        <param name=\"CTYPE\">" + selectedCardType + "</param>\n" +
                "        <param name=\"APPID\">" + Constants.APPID + "</param>\n" +
                "        <param name=\"DTID\">" + Constants.DTID + "</param>\n" +
                "        <param name=\"AGENT_ID\">" + agentId + "</param>\n" +
                "        <param name=\"SEGMENT_ID\">" + segmentId + "</param>\n" +
                "    </params>\n" +
                "</msg>";
        AppLogger.i("XML Request: " + requestString + "\n");
    ...
    public HttpResponseModel thirdPartyCashOutInfo(int command, String pid,
                                                   String cnicOrMobile, String amount, String mobile, String imei, String macAddress) throws Exception {
        String xml = "";
        ...
        if (pid.equals(Constants.PRODUCT_ID_3RD_PARTY_CASH_OUT)) {
            xml = xml + "<param name=\"CMOB\">" + mobile + "</param>";
        }
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"LONGITUDE\">" + ApplicationData.longitude + "</param>"
                + "<param name=\"LATITUDE\">" + ApplicationData.latitude + "</param>"
                + "<param name=\"IMEI_NUMBER\">" + imei + "</param>"
                + "<param name=\"MAC_ADDRESS\">" + macAddress + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel proofOfLifeInfo(int command, String pid,
                                      String mobileNumber, String cnic, String segmentCode, String lat,String log,
                                             String machineName, String macAddress) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"CNIC\">" + cnic + "</param>"
                + "<param name=\"THIRD_PARTY_CUST_SEGMENT_CODE\">" + segmentCode + "</param>"
                + "<param name=\"LATITUDE\">" + lat + "</param>"
                + "<param name=\"LONGITUDE\">" + log + "</param>"
                + "<param name=\"AGENT_ID\">" + ApplicationData.userId + "</param>"
                + "<param name=\"MACHINE_NAME\">" + machineName + "</param>"
                + "<param name=\"MAC_ADDRESS\">" + macAddress + "</param>"
                + "<param name=\"UDID\">" + ApplicationData.deviceId + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel proofOfLife(int command, String pin,  String pid,
                                             String mobileNumber, String cnic, String segmentCode, String lat,String log,
                                             String machineName, String macAddress, String fingerIndex, String template,
                                         String templateType, String statusFlag, String nadraSessionId) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"TEMPLATE_TYPE\">" + templateType + "</param>"
                + "<param name=\"FINGER_TEMPLATE\">" + template + "</param>"
                + "<param name=\"STATUS\">" + statusFlag + "</param>"
                + "<param name=\"NADRA_SESSION_ID\">" + nadraSessionId + "</param>"
                + "<param name=\"UDID\">" + ApplicationData.deviceId + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel BOPCashOutInfo(int command,
                                      String cmob, String pid,
                                      String amount, String isCard,
                                      String segmentCode, String dcno, String cnic) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"CMOB\">" + cmob + "</param>"
                + "<param name=\"CNIC\">" + cnic + "</param>"
                + "<param name=\"DCNO\">" + dcno + "</param>"
                + "<param name=\"IS_CARD\">" + isCard + "</param>"
                + "<param name=\"THIRD_PARTY_CUST_SEGMENT_CODE\">" + segmentCode + "</param>"
    ...
    public HttpResponseModel BOPCardIssuanceReIssuance(int command, String pid,
                                            String mob, String cnic,
                                            String card, String transactionType,
                                            String segmentCode, String lat, String log,String agentId) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"CNIC\">" + cnic + "</param>"
                + "<param name=\"DCNO\">" + card + "</param>"
                + "<param name=\"TRANSACTION_TYPE\">" + transactionType + "</param>"
                + "<param name=\"THIRD_PARTY_CUST_SEGMENT_CODE\">" + segmentCode + "</param>"
                + "<param name=\"LATITUDE\">" + lat + "</param>"
                + "<param name=\"LONGITUDE\">" + log + "</param>"
                + "<param name=\"TERMINAL_ID\">" + agentId + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel agentIBFT(int command,
                                       ...
                                       String bankName,String branchName,String iban,String crDr,String accTitle, String tamt ) throws Exception {
    ...
    public HttpResponseModel thirdPartyCashOut(int command, String pin, String pid,
            ...
            , String NFIQuality, String minutiaeCount, String thirdPartyTransactionId,
                                               ...
                                               String walletNumber,
                                               String walletBal, String isWalletTran, String count
            , String imei, String macAddress) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"IMEI_NUMBER\">" + imei + "</param>"
                + "<param name=\"MAC_ADDRESS\">" + macAddress + "</param>"
                + "<param name=\"WSQ_COUNT\">" + count + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel BOPCashOut(int command, String pin, String pid,
                                               String cmob, String trxId,
                                               String amount, String isBvsReqString, String fingerIndex,
                                               String templateType, String template, String camt,
                                        String tpam, String tamt, String otp, String iscard, String segmentId
            , String dcno, String cnic) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"TAMT\">" + tamt + "</param>"
                + "<param name=\"CMOB\">" + cmob + "</param>"
                + "<param name=\"IS_BVS_REQ\">" + isBvsReqString + "</param>"
                + "<param name=\"FINGER_INDEX\">" + fingerIndex + "</param>"
                + "<param name=\"TEMPLATE_TYPE\">" + templateType + "</param>"
                + "<param name=\"FINGER_TEMPLATE\">" + template + "</param>"
                + "<param name=\"THIRD_PARTY_TRANSACTION_ID\">" + trxId + "</param>"
                + "<param name=\"IS_CARD\">" + iscard + "</param>"
                + "<param name=\"DCNO\">" + dcno + "</param>"
                + "<param name=\"THIRD_PARTY_CUST_SEGMENT_CODE\">" + segmentId + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel BOPCardIssuanceReIssuanceConform(int command, String pin, String pid,
                                        String cmob, String cnic,
                                        String dcno, String nadraSessionId,String segmentCode, String fingerIndex,
                                        String templateType, String template, String NFIQuality,
                                        String minutiaeCount) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"LATITUDE\">" + ApplicationData.latitude + "</param>"
                + "<param name=\"LONGITUDE\">" + ApplicationData.longitude + "</param>"
                + "<param name=\"TERMINAL_ID\">" + ApplicationData.userId + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel agentBvsFailed(int command, String bvsFail) throws Exception {

        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                + new Date().getTime() + "\"><params>"
                + "<param name=\"DTID\">5</param>"
                + "<param name=\"AGENT_ID\">" + ApplicationData.userId + "</param>"
                + "<param name=\"BVS_FAIL\">" + bvsFail + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel fetchCardTypes(int command) throws Exception {
    ...
    public HttpResponseModel openAccountFetchSegments(int command) throws Exception {
    ...
    public HttpResponseModel fetchSegments(int command) throws Exception {
    ...
    public HttpResponseModel cashOutInfo(int command, String PID, String CMOB,
                                         String AMOB, String TXAM, String isHRA, String CNIC, String hraLinkedRequest, String isOtpReq) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"IS_OTP_REQ\">" + isOtpReq + "</param>"
    ...
    public HttpResponseModel cashOut(int command, String pin, String pid,
                                     ...
                                     String tpam, String tamt, String isHRA, String trxId, String otp, String isOtpReq) throws Exception {
    ...
    public HttpResponseModel ftCnicToBlbInfo(int command, String pid,
                                             String amob, String swmob, String swcnic, String rcmob, String txam) throws Exception {
    ...
    public HttpResponseModel exciseAndTaxationInfo(int command, String PID,
                                                   String vehRegNo, String vehChassisNo, String cmob) throws Exception {

        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                + new Date().getTime() + "\"><params>"
                + "<param name=\"DTID\">5</param>"
                + "<param name=\"PID\">" + PID + "</param>"
                + "<param name=\"VEH_REG_NO\">" + vehRegNo + "</param>"
                + "<param name=\"VEH_CHASSIS_NO\">" + vehChassisNo + "</param>"
                + "<param name=\"CMOB\">" + cmob + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel exciseAndTaxationPayment(int command, String PID, String vehChassisNo, String vehRegNo, String assessmentNo,
                                                      String totalAmount, String cmob) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\""
                ...
                + "<param name=\"ENCT\">" + 1 + "</param>"
                + "<param name=\"PID\">" + PID + "</param>"
                + "<param name=\"VEHICLE_CHESIS_NO\">" + vehChassisNo + "</param>"
                + "<param name=\"VEH_REG_NO\">" + vehRegNo + "</param>"
                + "<param name=\"ASSESSMENT_NO\">" + assessmentNo + "</param>"
                + "<param name=\"ASSESSMENT_AMOUNT\">" + totalAmount + "</param>"
                + "<param name=\"TPAM\">" + 0.0 + "</param>"
    ...
    public HttpResponseModel KhidmatCardRegistration(int command, String mobileNmber, String cnic, String cardNumber,
                                                     String segmentCode) throws Exception {


        String requestString = "<msg id=\"" + command + "\" reqTime=\"" + new Date().getTime() + "\"><params>"
                + "<param name=\"DTID\">5</param>"

                + "<param name=\"CMOB\">" + mobileNmber + "</param>"
                + "<param name=\"CNIC\">" + cnic + "</param>"
                + "<param name=\"DCNO\">" + cardNumber + "</param>"
                + "<param name=\"THIRD_PARTY_CUST_SEGMENT_CODE\">" + segmentCode + "</param>"
                + "<param name=\"TERMINAL_ID\">" + ApplicationData.userId + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel KhidmatCardRegistrationConfirmation(int command, String mpin, String fingerIndex,String tempString,String tempType, String otp,
                                                                 String cmob, String cnic, String card, String segmentId, String productId, String nadraSessionId) throws Exception {
        ...
        String requestString = "<msg id=\"" + command + "\" reqTime=\"" + new Date().getTime() + "\"><params>"
                ...
                + "<param name=\"THIRD_PARTY_CUST_SEGMENT_CODE\">" + segmentId + "</param>"
                + "<param name=\"FINGER_INDEX\">" + fingerIndex + "</param>"
                + "<param name=\"TEMPLATE_TYPE\">" + tempType + "</param>"
                + "<param name=\"FINGER_TEMPLATE\">" + tempString + "</param>"
                + "<param name=\"TERMINAL_ID\">" + ApplicationData.userId + "</param>"
    ...
    public HttpResponseModel openAccountVerifyCustomerRegistration(int command, String msisdn,
                                                                   ...
                                                                   String userId,String productId,String segmentId)
            throws Exception {
        ...
        String requestString = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><msg id=\""
                ...
                + "<param name=\"AGENT_ID\">" + userId + "</param>"
                + "<param name=\"PID\">" + productId + "</param>"
                + "<param name=\"SEGMENT_ID\">" + segmentId + "</param>"
                + "</params></msg> ";
    ...
    public HttpResponseModel openAccountBvs(int command, String mpin, String mobileNumber,
                                            ...
                                            String strMobileNetwork,String segmentId
    ) throws Exception {
