...
public class XmlParser {
    ...
    public void parseInfoMsg(Hashtable<String, Object> table)
        ...
        ArrayList<SegmentModel> segments = null;
        ArrayList<SegmentModel> cardTypes = null;
        ArrayList<BankModel> banks = null;
                ...
                if (startTag != null) {
                    ...
                    if (startTag.equals(Constants.TAG_PARAM)) {
                        ...
                        paymentReasons.add(new PaymentReasonModel(parser.getAttributeValue(
                                ...
                                null, Constants.ATTR_PARAM_NAME)));
                    } else if (startTag.equals(Constants.TAG_SEGMENTS)) {
                        segments = new ArrayList<SegmentModel>();
                    } else if (startTag.equals(Constants.TAG_SEGMENT)) {
                        segments.add(new SegmentModel(parser.getAttributeValue(
                                null, Constants.ATTR_PARAM_NAME), parser.getAttributeValue(
                                null, Constants.ATTR_PARAM_CODE), parser.getAttributeValue(
                                        null, Constants.ATTR_PARAM_SEG_ID)));
                    }else if (startTag.equals(Constants.TAG_CARDTYPES)) {
                        cardTypes = new ArrayList<SegmentModel>();
                    } else if (startTag.equals(Constants.TAG_CARDTYPE)) {
                        cardTypes.add(new SegmentModel(parser.getAttributeValue(
                                null, Constants.ATTR_PARAM_NAME), parser.getAttributeValue(
                                null, Constants.ATTR_PARAM_CODE)));
                    }
                }
            }
            if (eventType == XmlPullParser.END_TAG) {
                ...
                } else if (endTag.equals(Constants.TAG_SEGMENTS)) {
                    table.put(Constants.TAG_SEGMENTS, segments);
                } else if (endTag.equals(Constants.TAG_CARDTYPES)) {
                    table.put(Constants.TAG_CARDTYPES, cardTypes);
                }
            }
            eventType = parser.next();
        }
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (startTag != null) {
                    ...
                    if (startTag.equals(Constants.TAG_PARAM)) {
                        ...
                        trans.setIsCard(parser.getAttributeValue(null, Constants.ATTR_IS_CARD));
                        trans.setDCNO(parser.getAttributeValue(null, Constants.ATTR_DCNO));
                        trans.setRacnic(parser.getAttributeValue(null, Constants.ATTR_CNIC));
                        transList.add(trans);
                    } else if (startTag.equals(Constants.TAG_MESGS)) {
                        msgs = new ArrayList<MessageModel>(2);
                    } else if (startTag.equals(Constants.TAG_MESG)) {
