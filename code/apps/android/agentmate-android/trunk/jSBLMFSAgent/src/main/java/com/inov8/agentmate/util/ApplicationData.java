...
public class ApplicationData {
    ...
    public static ArrayList<SegmentModel> listSegments = null;
    public static ArrayList<SegmentModel> listCardTypes = null;
    public static ArrayList<SegmentModel> listOpenAccountSegments = null;
	public static String accountOpenMinAmount=null;
    public static String accountOpenMaxAmount=null;
    public static String imei=null;
    public static String selectedOpenAccountSegmentId=null;
