...
public class BuildConstants{
    ...
    public static final String BASE_URL = "blbstg.jsbl.com:2087/i8Microbank"; // Staging
    public static final String APP_DOWNLOAD_URL = PROTOCOL +
            "blbstg.jsbl.com:2087/downloads/agent.html"; // Staging HTTPS

//    public static final String HOSTNAME = "blbstg.jsbl.com:2087"; // Staging HTTPS
