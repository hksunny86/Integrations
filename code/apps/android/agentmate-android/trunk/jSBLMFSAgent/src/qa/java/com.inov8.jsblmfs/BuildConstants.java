...
//    public static final String NADRA_VERIFICATION_URL = "http://jsblb.inov8.com.pk/nadra-biometric-integration/service/verify";  // QA
    public static final String NADRA_VERIFICATION_URL = "http://akblqa.inov8.com.pk/nadra-biometric-integration/service/verify";  // QA
    public static final String NADRA_OTC_URL = "http://akblqa.inov8.com.pk/nadra-biometric-integration/service/verifyOTC";  // QA
