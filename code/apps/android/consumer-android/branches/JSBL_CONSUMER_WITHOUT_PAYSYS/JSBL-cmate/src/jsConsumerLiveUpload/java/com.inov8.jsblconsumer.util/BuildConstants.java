...
public class BuildConstants {
    ...
    public static final String SIGNATURE = mySig();
    ...
    public static native String getScanner13();

    public static native String getScanner14();

    public static native String getScanner15();

    public static native String getScanner16();
