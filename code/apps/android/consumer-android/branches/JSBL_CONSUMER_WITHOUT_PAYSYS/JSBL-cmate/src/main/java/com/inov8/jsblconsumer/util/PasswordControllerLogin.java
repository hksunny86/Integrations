...
public class PasswordControllerLogin {
    ...
    public PasswordControllerLogin(View v, boolean finalActionNext, boolean isAlphaNumeric, Context context) {
...
//        etList.add((EditText) v.findViewById(R.id.tv_pass6));
...
//    }
    ...
    public void setHint(String strHint) {
        TextView hintTextOtp = (TextView) view.findViewById(R.id.hint_text_otp);
        hintTextOtp.setText(strHint);
    }
    public void hideShowPasswordIcon(){
        view.findViewById(R.id.showPassword).setVisibility(View.GONE);
    }
}
