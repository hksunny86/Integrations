...
public class TransferInConfirmationActivity extends BaseCommunicationActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        titleImplementation(null, product.getName(), "Confirm Transaction", TransferInConfirmationActivity.this);
        ...
        btnCancel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                dialogGeneral = popupDialogs.createConfirmationDialog(AppMessages.CANCEL_TRANSACTION, AppMessages.ALERT_HEADING,
                        TransferInConfirmationActivity.this, getString(R.string.yes), getString(R.string.no), new OnClickListener() {
                            @Override
                            public void onClick(View v) {
    ...
    public void processRequest() {
        if (!haveInternet()) {
            PopupDialogs.createAlertDialog(AppMessages.INTERNET_CONNECTION_PROBLEM,
                    AppMessages.ALERT_HEADING, TransferInConfirmationActivity.this, PopupDialogs.Status.ERROR);
            return;
        }

        showLoading("Please Wait", "Processing...");
        new HttpAsyncTask(TransferInConfirmationActivity.this).execute(
                Constants.CMD_TRANSFER_IN + "", getEncryptedMpin(),
        ...
        try {
            ...
            if (table != null && table.containsKey(Constants.KEY_LIST_ERRORS)) {
                ...
                dialogGeneral = PopupDialogs.createAlertDialog(message.getDescr(), getString(R.string.alertNotification),
                        TransferInConfirmationActivity.this, new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
