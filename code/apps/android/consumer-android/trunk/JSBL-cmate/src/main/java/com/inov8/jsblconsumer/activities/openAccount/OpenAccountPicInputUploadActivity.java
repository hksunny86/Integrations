...
//    private final byte IMAGE_CUSTOMER = 0;
//    private final byte IMAGE_NIC_FRONT = 1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mAccountLevel = mBundle.getString(Constants.ATTR_CUST_ACC_TYPE);
        ...
        btnNextScreen.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mBundle.putBoolean("Customer", flagUploadCustomer);
                mBundle.putBoolean("NIC Front", flagUploadCnicFront);
    ...
    private void loadCustomerLayout() {
        ...
        btnCustomer.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mBundle.putBoolean(Constants.IntentKeys.OPEN_FRONT_CAMERA,false);
    ...
    private void loadNICFrontLayout() {
        ...
        btnNICFront.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mBundle.putBoolean(Constants.IntentKeys.OPEN_FRONT_CAMERA,true);
                intent.putExtras(mBundle);
                startActivityForResult(intent,
    ...
    public void showAlertPopup(final String type) {
        ...
        dialogGeneral = popupDialogs.createConfirmationDialog("Do you want to upload this picture?", AppMessages.ALERT_HEADING,
                OpenAccountPicInputUploadActivity.this, getString(R.string.yes), getString(R.string.no), new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ...
                        if (!haveInternet()) {
                            ...
                            switch (type) {
                                ...
                                case IMAGE_NIC_FRONT:
                                    ...
                                    lblNICFront.setText("NIC Front photo is saving...");
...
//        dialogGeneral = PopupDialogs.createConfirmationDialog("Do you want to upload this picture?", getString(R.string.alertNotification), OpenAccountPicInputUploadActivity.this, new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                dialogGeneral.cancel();
//                if (!haveInternet()) {
...
//        });
    ...
    public void showAlertPopup1(final String type) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (data != null && data.getStringExtra("RESULT").equals("ERROR"))
                ...
                dialogGeneral = popupDialogs.createAlertDialog("Camera not available on device!", AppMessages.ALERT_HEADING,
                        OpenAccountPicInputUploadActivity.this, getString(R.string.ok), new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
...
//
//            PopupDialogs.createAlertDialog("Camera not available on device!",
//                        "", OpenAccountPicInputUploadActivity.this, PopupDialogs.Status.ERROR
//                );
        }
    }
