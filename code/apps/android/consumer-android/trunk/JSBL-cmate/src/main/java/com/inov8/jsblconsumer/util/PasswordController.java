...
public class PasswordController {
    ...
    public PasswordController(View v, boolean finalActionNext, boolean isAlphaNumeric, Context context) {
...
//                    if (hasFocus) {
//                        tv_password.setTextColor(context.getResources().getColor(R.color.colorAccent));
//                    } else {
//                        tv_password.setTextColor(context.getResources().getColor(R.color.text_grey_heading));
//                    }
//                }
//            });
//        }
...
//
//    public void setTv_error(TextView tv_error) {
...
//        ForgotPasswordActivity.isPasswordLoaded = true;
//        ForgotPasswordActivity.passcode = "";
    }
    ...
    public void setError(String mes){
        etList.get(3).setError(mes);
        etList.get(3).requestFocus();
    }
}
