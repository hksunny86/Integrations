...
public class QRcodeGenerator1 {
    ...
    public static Map genericQRCodeBreak(String qr){
        ...
        if(fieldIdentifier.equals(QRCodeEnum1.INITIATION_METHOD.getValue())){
            ...
            fieldMap.put(fieldIdentifier,fieldValue);
            if(fieldValue.equals(QRCodeEnum1.MASTERCARD_DYNAMIC.getValue()))
                isDynamic = true;
            AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
        }

        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.PAN.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            endTag = endTag + 4;
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
        ...
        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.MCC.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            endTag = endTag + 4;
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
        ...
        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.CURRENCY_CODE.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            endTag = endTag + 4;
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
        ...
        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.TRANSACTION_AMOUNT.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            endTag = endTag + 4;
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
        ...
        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.TRANSACTION_TIP.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            endTag = endTag + 4;
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
        ...
        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.COUNTRY_CODE.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            endTag = endTag + 4;
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
        ...
        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.MERCHANT_NAME.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            endTag = endTag + 4;
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
        ...
        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.MERCHANT_CITY.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            endTag = endTag + 4;
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
        ...
        fieldIdentifier = qr.substring(endTag,endTag+2);
        if(fieldIdentifier.equals(QRCodeEnum1.ADDITIONAL_DATA.getValue())){
            fieldLength = String.valueOf((Integer.parseInt(qr.substring(endTag+2,endTag+4))));
            ...
            if(isDynamic){
                if(addidtionalDataFieldIdentifier.equals(QRCodeEnum1.BILL_NO.getValue())){
                ...
                addidtionalDataFieldIdentifier = additionalDataString.substring(additionalDataEndTag,additionalDataEndTag+2);
                if(addidtionalDataFieldIdentifier.equals(QRCodeEnum1.MERCHAN_ID_SUB_CATEGORY.getValue())){
                ...
                if(additionalDataString.length() != additionalDataEndTag){
                    addidtionalDataFieldIdentifier = additionalDataString.substring(additionalDataEndTag,additionalDataEndTag+2);
                    if(addidtionalDataFieldIdentifier.equals(QRCodeEnum1.REFERENCE_NO.getValue())){
                        addidtionalDataFieldLength = String.valueOf((Integer.parseInt(additionalDataString.substring(additionalDataEndTag+2,additionalDataEndTag+4))));
                        additionalDataEndTag = additionalDataEndTag + 4;
                        addidtionalDataFieldValue = additionalDataString.substring(additionalDataEndTag , (additionalDataEndTag+ Integer.parseInt(addidtionalDataFieldLength)));
                        additionalDataEndTag = (additionalDataEndTag+ Integer.parseInt(addidtionalDataFieldLength));
                    ...
                    if(addidtionalDataFieldIdentifier.equals(QRCodeEnum1.PURPOSE.getValue())){
                        addidtionalDataFieldLength = String.valueOf((Integer.parseInt(additionalDataString.substring(additionalDataEndTag+2,additionalDataEndTag+4))));
                        additionalDataEndTag = additionalDataEndTag + 4;
                        addidtionalDataFieldValue = additionalDataString.substring(additionalDataEndTag , (additionalDataEndTag+ Integer.parseInt(addidtionalDataFieldLength)));
                        fieldMap.put(addidtionalDataFieldIdentifier,addidtionalDataFieldValue);
...
//            if(!TextUtils.isEmpty(addidtionalDataFieldIdentifier) && addidtionalDataFieldIdentifier.equals(QRCodeEnum1.PURPOSE.getValue())){
//                addidtionalDataFieldLength = additionalDataString.substring(additionalDataEndTag+2,additionalDataEndTag+4);
...
//            }
    ...
    private static Map breakOldMasterCardQRCode(String qr){
        ...
        if(fieldIdentifier.equals("00")){
            ...
            fieldMap.put(QRCodeEnum1.PAN.getValue(),merchantPan);
        ...
        if(fieldIdentifier.equals("03")){
            ...
            fieldMap.put(QRCodeEnum1.MERCHAN_ID_SUB_CATEGORY.getValue(),fieldValue);
            AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
        }
        ...
        fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
        endTag = (endTag+ Integer.parseInt(fieldLength));
        fieldMap.put(QRCodeEnum1.MERCHANT_NAME.getValue(),fieldValue);
        AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
        ...
        fieldValue = qr.substring(endTag , (endTag+(Integer.parseInt(fieldLength))));
        endTag = (endTag+ Integer.parseInt(fieldLength));
        fieldMap.put(QRCodeEnum1.MCC.getValue(),fieldValue);
        AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
        ...
        fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
        endTag = (endTag+ Integer.parseInt(fieldLength));
        fieldMap.put(QRCodeEnum1.MERCHANT_CITY.getValue(),fieldValue);
        AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
...
//        fieldLength = qr.substring(endTag+2,endTag+4);
        ...
        if(fieldIdentifier.equals("0D")){
            ...
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
            fieldMap.put(QRCodeEnum1.COUNTRY_CODE.getValue(),fieldValue);
            AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
        }
        ...
        if(fieldIdentifier.equals("0E")){
            ...
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
            fieldMap.put(QRCodeEnum1.CURRENCY_CODE.getValue(),fieldValue);
            AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
        }
        ...
        if(fieldIdentifier.equals("A1")){
            ...
            fieldValue = qr.substring(endTag , (endTag+ Integer.parseInt(fieldLength)));
            endTag = (endTag+ Integer.parseInt(fieldLength));
            fieldMap.put(QRCodeEnum1.TRANSACTION_AMOUNT.getValue(),fieldValue);
            AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
        }
        ...
        if(fieldIdentifier.equals("A3")) {
            ...
            fieldValue = qr.substring(endTag, (endTag + Integer.parseInt(fieldLength)));
            endTag = (endTag + Integer.parseInt(fieldLength));
            fieldMap.put(QRCodeEnum1.BILL_NO.getValue(), fieldValue);
            AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
        }
        ...
        if(fieldIdentifier.equals("A5")) {
            ...
            if(fieldValue.length() == 12){
                fieldMap.put(QRCodeEnum1.REFERENCE_NO.getValue(), fieldValue);
                AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
            }else {
                fieldMap.put(QRCodeEnum1.MERCHAN_ID_SUB_CATEGORY.getValue(),fieldValue);
                AppLogger.i("Field Identifier: "+fieldIdentifier+", Field Value: "+fieldValue);
