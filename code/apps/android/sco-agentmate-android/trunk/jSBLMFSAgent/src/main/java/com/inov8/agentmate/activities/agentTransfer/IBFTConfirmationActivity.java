...
public class IBFTConfirmationActivity extends BaseCommunicationActivity implements MpinInterface {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String labels[] = new String[]{"Receiver Account No.",
                    ...
                    "Total Amount"};
            String data[] = new String[]{transactionInfo.getCoreacid(), transactionInfo.getCoreactl(),
                    transactionInfo.getBankName(),
    ...
    public void processRequest() {
        ...
        new HttpAsyncTask(IBFTConfirmationActivity.this).execute(
                ...
                transactionInfo.getTamt(),transactionInfo.getBankName(),transactionInfo.getBranchName(),transactionInfo.getIban(),transactionInfo.getCrDr(),
                transactionInfo.getCoreactl());
    }
