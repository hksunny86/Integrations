...
public class CashInInputActivity extends BaseCommunicationActivity {
	...
	public void processRequest() {
		...
		new HttpAsyncTask(CashInInputActivity.this).execute(
				Constants.CMD_CASH_IN_INFO + "", product.getId(), input1
						.getText().toString(),
		...
		try {
			...
			if (table != null && table.containsKey(Constants.KEY_LIST_ERRORS)) {
				...
				transactionInfo.CashInOut(table.get(Constants.ATTR_CMOB)
						.toString(), table.get(Constants.ATTR_NAME).toString(),
				...
				Intent intent = new Intent(getApplicationContext(),
						CashInConfirmationActivity.class);
