...
import com.inov8.agentmate.bvs.sco.ScoHandler;
...
public class BvsActivity extends BaseActivity implements View.OnClickListener, BvsController.BvsCompleteListner {
    ...
    private void init() {
        ...
        ApplicationData.bvsdeviceModel = Build.DEVICE;
    ...
    private BvsController getDeviceInstance() {
        if(ApplicationData.bvsDeviceName.equals(Constants.BvsDevices.SCO))
            return new ScoHandler(this);
        else if(ApplicationData.bvsDeviceName.equals(Constants.BvsDevices.SUPREMA))
