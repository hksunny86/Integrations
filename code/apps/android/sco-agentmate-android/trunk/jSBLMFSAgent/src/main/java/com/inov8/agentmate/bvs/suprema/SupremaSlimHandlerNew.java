...
public class SupremaSlimHandlerNew extends BvsController {
    ...
    public SupremaSlimHandlerNew(Activity activity) {
            ...
            new Thread(() -> {
                ...
                if (mBioMiniFactory != null) {
                    ...
                    if (mCurrentDevice != null) {
                        ...
                        mCurrentDevice.setParameter(new IBioMiniDevice.Parameter(IBioMiniDevice.ParameterType.TIMEOUT, 10));
