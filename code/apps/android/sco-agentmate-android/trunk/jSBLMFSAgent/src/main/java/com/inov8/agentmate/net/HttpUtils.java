...
public class HttpUtils {
    ...
    public static HttpResponseModel sendHttpCall(String command, HttpURLConnection httpUrlConnection, String requestString)
            throws Exception {
           ...
           // parseSessionID(urlConnection.getHeaderField("Set-Cookie"));
            ...
            switch (statusCode) {
                ...
                case HttpURLConnection.HTTP_NOT_FOUND:
                    throw new InvalidResponseException(Constants.Messages.EXCEPTION_HTTP_UNAVAILABLE);
                case HttpURLConnection.HTTP_GATEWAY_TIMEOUT:
                    throw new TimeoutException(Constants.Messages.EXCEPTION_TIME_OUT);
