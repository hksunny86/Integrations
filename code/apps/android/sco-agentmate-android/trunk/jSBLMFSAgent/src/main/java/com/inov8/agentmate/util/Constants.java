...
public class Constants {
    ...
    public static final String APPLICATION_VERSION = "2.0.11.13";
    ...
    public static final int CMD_CASH_WITH_DRAWAL = 227;
    ...
    public static final String PRODUCT_ID_CASH_OUT_BY_TRX_ID = "50051";
    ...
    public static final String PRODUCT_ID_3RD_PARTY_CASH_OUT = "2510812";
    ...
    public static final int REQUEST_CODE_BIOMETRIC_SELECTION1 = 125;
    public static final int REQUEST_CODE_BIOMETRIC_SELECTION = 125;
    public static final int REQUEST_CODE_BIOMETRIC_SELECTION2 = 126;
    ...
    public static final String ERROR_CUSTOMER_NOT_FOUND = "111";
