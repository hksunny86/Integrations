...
/**
 * The AccountsStatsRangeListViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="AccountsStatsRangeListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "ACCOUNTS_STATS_RANGE_LIST_VIEW")
public class AccountsStatsRangeListViewModel extends BasePersistableModel implements Serializable {
    ...
    * Default constructor.
    */
   public AccountsStatsRangeListViewModel() {
   }   
