...
@javax.persistence.SequenceGenerator(name = "BLINK_DEFAULT_LIMIT_SEQ",sequenceName = "BLINK_DEFAULT_LIMIT_SEQ", allocationSize=1)
@Table(name = "BLINK_DEFAULT_LIMIT")
public class BlinkDefaultLimitModel extends BasePersistableModel implements Serializable ,RowMapper {
    ...
    * Default constructor.
    */
   public BlinkDefaultLimitModel() {
   }


    public BlinkDefaultLimitModel(Double minimum, Double maximum )
    {
        super();
    ...
    *
    */
      @Column(name = "BLINK_DEFAULT_LIMIT_ID" , nullable = false )
   @Id @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="BLINK_DEFAULT_LIMIT_SEQ")
   ...
   public String getPrimaryKeyParameter() {
    ...
    public Object mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        BlinkDefaultLimitModel vo=new BlinkDefaultLimitModel();
        ...
        vo.setLimitId(resultSet.getLong("BLINK_DEFAULT_LIMIT_ID"));
