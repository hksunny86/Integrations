...
@Entity
@Table(name = "AGENT_MONTHLY_TX_STATS_VIEW")
public class AgentMonthlyTxStatsViewModel extends BasePersistableModel implements Serializable
{
	/**
     * serialVersionUID
     */
    ...
    /** default constructor */
    public AgentMonthlyTxStatsViewModel()
    {
    }
