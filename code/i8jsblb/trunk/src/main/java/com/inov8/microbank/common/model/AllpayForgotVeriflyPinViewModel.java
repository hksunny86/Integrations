...
/**
 * The AllpayForgotVeriflyPinViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="AllpayForgotVeriflyPinViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "ALLPAY_FORGOT_VERIFLY_PIN_VIEW")
public class AllpayForgotVeriflyPinViewModel extends BasePersistableModel implements Serializable {
    ...
    * Default constructor.
    */
   public AllpayForgotVeriflyPinViewModel() {
   }   
