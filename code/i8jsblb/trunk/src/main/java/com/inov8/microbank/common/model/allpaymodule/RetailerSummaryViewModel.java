...
/**
 * The RetailerSummaryViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="RetailerSummaryViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "RETAILER_SUMMARY_VIEW")
public class RetailerSummaryViewModel extends BasePersistableModel implements Serializable {
    ...
    * Default constructor.
    */
   public RetailerSummaryViewModel() {
   }   
   ...
   /**
    * Returns the value of the <code>billCollection</code> property.
    *
    */
   ...
   /**
    * Sets the value of the <code>billCollection</code> property.
    *
    * @param billCollection the value for the <code>billCollection</code> property
    *    
		    * @spring.validator type="double"
    * @spring.validator type="doubleRange"		
    * @spring.validator-args arg1value="${var:min}"
