...
/**
 * The BankUserListViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="BankUserListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "BANK_USER_LIST_VIEW")
public class BankUserListViewModel extends BasePersistableModel implements Serializable {
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = -3200868980655504557L;
private Long bankUserId;
    ...
    *
    */
      @Column(name = "PARTNER_GROUP_NAME" , nullable = false , length=50 )
