...
@javax.persistence.SequenceGenerator(name = "BLINK_CUSTOMER_PICTURE_seq", sequenceName = "BLINK_CUSTOMER_PICTURE_seq", allocationSize = 2)
@Table(name = "BLINK_CUSTOMER_PICTURE")
public class BlinkCustomerPictureModel extends BasePersistableModel implements
        Serializable {
...
//    private Boolean discrepant;
    ...
    public BlinkCustomerPictureModel() {
    }
    ...
    // Property accessors
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "BLINK_CUSTOMER_PICTURE_seq")
    @Column(name = "BLINK_CUSTOMER_PICTURE_ID")
