package com.inov8.microbank.common.model.mobilehistorymodule;
...
/**
 * The MobileHistoryListViewModel entity bean.
 *
 * @author  Shoaib Akhtar  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="MobileHistoryListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "MOBILE_HISTORY_LIST_VIEW")
public class MobileHistoryListViewModel extends BasePersistableModel {
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = 3809849700936784899L;
private Long appUserMobileHistoryId;
    ...
    * Default constructor.
    */
   public MobileHistoryListViewModel() {
   }   
