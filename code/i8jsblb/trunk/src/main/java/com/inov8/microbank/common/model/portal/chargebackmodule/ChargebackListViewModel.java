package com.inov8.microbank.common.model.portal.chargebackmodule;
...
/**
 * The ChargebackListViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="ChargebackListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "CHARGEBACK_LIST_VIEW")
public class ChargebackListViewModel extends BasePersistableModel implements Serializable {
    ...
    * Default constructor.
    */
   public ChargebackListViewModel() {
   }   
   ...
   /**
    * Returns the value of the <code>rifm</code> property.
    *
    */
      @Column(name = "RIFM"  , length=3 )
   public String getRifm() {
      return rifm;
   }

   /**
    * Sets the value of the <code>rifm</code> property.
    *
    * @param rifm the value for the <code>rifm</code> property
    *    
		    * @spring.validator type="maxlength"     
    * @spring.validator-args arg1value="${var:maxlength}"
    * @spring.validator-var name="maxlength" value="3"
   ...
   public void setRifm(String rifm) {
      this.rifm = rifm;
   }
