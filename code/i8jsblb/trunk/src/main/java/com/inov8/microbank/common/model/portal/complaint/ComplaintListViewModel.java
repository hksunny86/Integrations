...
@Table(name = "COMPLAINT_LIST_VIEW")
public class ComplaintListViewModel extends BasePersistableModel {
   ...
   public String getPrimaryKeyParameter() {
	...
	public Short getExpectedTat() {
		return expectedTat;
	}

	public void setExpectedTat(Short expectedTat) {
