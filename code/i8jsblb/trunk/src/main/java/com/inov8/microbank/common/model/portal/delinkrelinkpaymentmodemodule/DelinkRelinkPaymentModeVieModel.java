package com.inov8.microbank.common.model.portal.delinkrelinkpaymentmodemodule;
...
/**
 * The DelinkRelinkPaymentModeVieModel entity bean.
 *
 * @author  Shoaib Akhtar  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="DelinkRelinkPaymentModeVieModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "DELINK_RELINK_PAYMENT_MODE_VIE")
public class DelinkRelinkPaymentModeVieModel extends BasePersistableModel {
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = -4611351849446003491L;
private Long pk;
    ...
    * Default constructor.
    */
   public DelinkRelinkPaymentModeVieModel() {
   }   
