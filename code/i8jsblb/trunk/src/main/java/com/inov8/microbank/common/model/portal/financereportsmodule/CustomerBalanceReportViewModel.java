...
@Table(name = "CUSTOMER_BALANCE_REPORT_VIEW")
public class CustomerBalanceReportViewModel extends BasePersistableModel implements Serializable
{
	...
	//default constructor
	public CustomerBalanceReportViewModel() {
	}
