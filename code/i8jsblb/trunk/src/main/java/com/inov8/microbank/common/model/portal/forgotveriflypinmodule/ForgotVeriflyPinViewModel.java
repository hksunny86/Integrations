package com.inov8.microbank.common.model.portal.forgotveriflypinmodule;
...
/**
 * The ForgotVeriflyPinViewModel entity bean.
 *
 * @author  Shoaib Akhtar  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="ForgotVeriflyPinViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "FORGOT_VERIFLY_PIN_VIEW")
public class ForgotVeriflyPinViewModel extends BasePersistableModel {
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = 5577611996508388131L;
private Long pk;
    ...
    * Default constructor.
    */
   public ForgotVeriflyPinViewModel() {
   }   
