 ...
 */
@XmlRootElement(name = "transactionDetailPortalListModel")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "TRANSACTION_DETAIL_PORTAL_LIST")
public class TransactionDetailPortalListModel extends BasePersistableModel implements Serializable {
...
//   private Double mcpl;
     ...
     * Default constructor.
     */
    public TransactionDetailPortalListModel() {
    }
