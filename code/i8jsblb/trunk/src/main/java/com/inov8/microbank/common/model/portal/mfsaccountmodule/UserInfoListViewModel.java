...
/**
 * The UserInfoListViewModel entity bean.
 *
 * @author Shoaib Akhtar  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 * @spring.bean name="UserInfoListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "USER_INFO_LIST_VIEW")
public class UserInfoListViewModel extends BasePersistableModel {
