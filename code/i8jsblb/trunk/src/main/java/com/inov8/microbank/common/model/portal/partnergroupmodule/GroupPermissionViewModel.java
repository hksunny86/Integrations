...
/**
 * The GroupPermissionViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="GroupPermissionViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "GROUP_PERMISSION_VIEW")
public class GroupPermissionViewModel extends BasePersistableModel implements Serializable {
   private static final long serialVersionUID = 8326599352023961772L;
