...
/**
 * The PaymentsListViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="PaymentsListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "PAYMENTS_LIST_VIEW")
public class PaymentsListViewModel extends BasePersistableModel implements Serializable {
