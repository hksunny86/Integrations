...
/**
 * The CustDispTranBlPmListViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="CustDispTranBlPmListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "CUST_DISP_TRAN_BL_PM_LIST_VIEW")
public class CustDispTranBlPmListViewModel extends BasePersistableModel implements Serializable {
    ...
    * Default constructor.
    */
   public CustDispTranBlPmListViewModel() {
   }   
