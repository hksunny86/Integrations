...
/**
 * The CustDisputeServiceListViewModel entity bean.
 *
 * @author  Shoaib Akhtar  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="CustDisputeServiceListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "CUST_DISPUTE_SERVICE_LIST_VIEW")
public class CustDisputeServiceListViewModel extends BasePersistableModel {
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = 1295758427727679013L;
private String serviceName;
    ...
    * Default constructor.
    */
   public CustDisputeServiceListViewModel() {
   }   
