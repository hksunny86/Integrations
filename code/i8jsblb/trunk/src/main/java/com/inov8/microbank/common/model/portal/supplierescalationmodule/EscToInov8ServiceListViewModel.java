...
/**
 * The EscToInov8ServiceListViewModel entity bean.
 *
 * @author  Jawwad Farooq  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="EscToInov8ServiceListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "ESC_TO_INOV8_SERVICE_LIST_VIEW")
public class EscToInov8ServiceListViewModel extends BasePersistableModel implements Serializable {
    ...
    * Default constructor.
    */
   public EscToInov8ServiceListViewModel() {
   }   
