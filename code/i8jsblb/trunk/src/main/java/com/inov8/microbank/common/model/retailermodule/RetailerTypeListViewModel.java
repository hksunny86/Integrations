...
/**
 * The RetailerTypeListViewModel entity bean.
 *
 * @author  Shoaib Akhtar  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="RetailerTypeListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "RETAILER_TYPE_LIST_VIEW")
public class RetailerTypeListViewModel extends BasePersistableModel {
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = -789225313023981474L;
private Long retailerTypeId;
    ...
    * Default constructor.
    */
   public RetailerTypeListViewModel() {
   }   
