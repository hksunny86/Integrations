package com.inov8.microbank.common.model.servicemodule;
...
/**
 * The ServiceTypeListViewModel entity bean.
 *
 * @author  Shoaib Akhtar  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="ServiceTypeListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "SERVICE_TYPE_LIST_VIEW")
public class ServiceTypeListViewModel extends BasePersistableModel {
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = -1051528894873951578L;
