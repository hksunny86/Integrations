...
/**
 * The VeriflyFormListViewModel entity bean.
 *
 * @author  Shoaib Akhtar  Inov8 Limited
 * @version $Revision: 1.20 $, $Date: 2006/03/06 19:29:08 $
 *
 *
 * @spring.bean name="VeriflyFormListViewModel"
 */
@Entity
@org.hibernate.annotations.Entity(mutable = false)
@Table(name = "VERIFLY_FORM_LIST_VIEW")
public class VeriflyFormListViewModel extends BasePersistableModel {
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = 7446613586633148598L;
private Long veriflyId;
    ...
    * Default constructor.
    */
   public VeriflyFormListViewModel() {
   }   
