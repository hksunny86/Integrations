 ...
 * Creation Time: 			1:03:43 PM
 * Description:				
 */
public class ExtremeTableCustomResourceBundle implements Messages {
    private static Log logger = LogFactory.getLog(ExtremeTableCustomResourceBundle.class);

    public final static String EXTREMETABLE_RESOURCE_BUNDLE = "extremetableResourceBundle";
