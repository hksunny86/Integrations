...
public class SettlementBBAccountsPDFView implements View {
    ...
    public SettlementBBAccountsPDFView() {
    }
        ...
        {		
          ...
          xlsfo.append(" <fo:table-cell > ");
           ...
           xlsfo.append(" </fo:table-row> ");
                    ...
                    ///////////////////Row 5//////////// 
           String settlementAccTitle=reportHeaderMap.get(BBStatementReportConstants.settlementAccTitle);
           String settlementAccNumber=reportHeaderMap.get(BBStatementReportConstants.settlementAccNumber);
 
           xlsfo.append(" <fo:table-row> ");
        	
        	xlsfo.append(" <fo:table-cell > ");
        	 xlsfo.append(" <fo:block font-weight=\"bold\"" + getFont() + ">Account Title:</fo:block> ");
        	xlsfo.append(" </fo:table-cell> ");
  	       
           xlsfo.append(" <fo:table-cell > ");
           xlsfo.append(" <fo:block" + getFont() + ">" + settlementAccTitle + "</fo:block> ");
	       xlsfo.append(" </fo:table-cell> ");
	       
	       xlsfo.append(" <fo:table-cell > ");
	       xlsfo.append(" <fo:block" + getFont() + ">Account #</fo:block>");
	       xlsfo.append(" </fo:table-cell> ");
           
           xlsfo.append(" <fo:table-cell > ");
	       xlsfo.append(" <fo:block" + getFont() + ">" + settlementAccNumber + "</fo:block> ");
	       xlsfo.append(" </fo:table-cell> ");
