...
public class SettlementBBAccountsXlsView extends XlsView {
	 ...
	 private void addReportHeader( TableModel model )
	    {
	        ...
	        {		
               ...
               ///////////////////Row 5//////////// 
                ...
                nameCell.setCellValue("Account Title: ");
                ...
                nameValueCell.setCellValue(reportHeaderMap.get(BBStatementReportConstants.settlementAccTitle));
                ...
                accountNoCell.setCellStyle( (HSSFCellStyle) styles.get("boldStyle") );
                accountNoCell.setCellValue("Account No: ");
               
                HSSFCell accountNoValueCell  = hssfRow.createCell((short)4);
                setCellEncoding( accountNoValueCell );	               
                accountNoValueCell.setCellType( HSSFCell.CELL_TYPE_STRING );
                accountNoValueCell.setCellStyle( (HSSFCellStyle) styles.get("boldStyle") );
                accountNoValueCell.setCellValue(reportHeaderMap.get(BBStatementReportConstants.settlementAccNumber));
