...
public class FonePayLogModel extends BasePersistableModel implements Serializable{
	...
	@Id @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="FONEPAY_INTEGERATION_LOG_SEQ")
