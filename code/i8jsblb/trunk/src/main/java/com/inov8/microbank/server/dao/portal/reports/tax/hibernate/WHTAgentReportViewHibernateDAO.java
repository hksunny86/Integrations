...
public class WHTAgentReportViewHibernateDAO extends BaseHibernateDAO<WHTAgentReportViewModel, Long, WHTAgentReportViewDAO> implements WHTAgentReportViewDAO
{
  
	@SuppressWarnings("unchecked")
	@Override
	public List<WHTAgentReportViewModel> loadAgentWHTReport(WHTAgentReportViewModel model,
        ...
        List<WHTAgentReportViewModel> list = null;
		...
		if(null!=model.getAgentId()){
			...
			CustomList<WHTAgentReportViewModel> customList = findByCriteria(criteria, model, null, null);
	    	...
	    	DetachedCriteria criteria = DetachedCriteria.forClass(WHTAgentReportViewModel.class);
	        ...
	        criteria = DetachedCriteria.forClass(WHTAgentReportViewModel.class);
	        criteria.add( Example.create( model ) );
	
	        DaoUtils.addSortingToCriteria( criteria, sortingOrderMap, model.getPrimaryKeyFieldName() );
	        
	        List<WHTAgentReportViewModel> results;
