...
public class AdvanceLoanPaymentCommand extends BaseCommand {
    private final Log logger = LogFactory.getLog(AdvanceLoanPaymentCommand.class);
    ...
    public void prepare(BaseWrapper baseWrapper) {
        if (logger.isDebugEnabled()) {
            logger.debug("Start of AdvanceLoanPaymentCommand.prepare()");
        }
        ...
        if(appUserModel.getMobileNo() == null){
            try {
    ...
    public ValidationErrors validate(ValidationErrors validationErrors) throws CommandException {
        if (logger.isDebugEnabled()) {
            logger.debug("Start of AdvanceLoanPaymentCommand.validate()");
        }
    ...
    public void execute() throws CommandException {
        ...
        try {
            ...
            if (validationErrors.hasValidationErrors()) {
                logger.error("[AdvanceLoanPayment.prepare] Throwing Exception for Product ID: " + productId + " Logged In AppUserID:" + appUserModel.getAppUserId() + " Customer Mobile No:" + customerMobileNo);
            ...
            if (appUserModel != null) {
                ...
                transactionTypeId = TransactionTypeConstantsInterface.ADVANCE_LOAN_PAYMENT_TX;
