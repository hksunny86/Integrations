...
public class AgentCreditCardInfoCommand extends BaseCommand 
{
	...
	protected final Log logger = LogFactory.getLog(AgentCreditCardInfoCommand.class);
	...
	public void execute() throws CommandException
	{
		...
		{
			logger.debug("Start of AgentCreditCardInfoCommand.execute()");
		}
...
//									To calculate the commission
									...
									transactionTypeModel.setTransactionTypeId(TransactionTypeConstantsInterface.AGENT_CREDIT_CARD_PAYMENT_TX);
									workFlowWrapper.setProductModel(productModel);
		...
		if(logger.isDebugEnabled())
		{
			logger.debug("End of AgentCreditCardInfoCommand.execute()");
		}
	}
	...
	public void prepare(BaseWrapper baseWrapper) 
	{
		if(logger.isDebugEnabled())
		{
			logger.debug("Start of AgentCreditCardInfoCommand.prepare()");
		}
		...
		if(logger.isDebugEnabled())
		{
			logger.debug("End of AgentCreditCardInfoCommand.prepare()");
		}
	}
	...
	public ValidationErrors validate(ValidationErrors validationErrors) throws CommandException
	{
		...
		validationErrors = ValidatorWrapper.doRequired(creditCardNumber,validationErrors,"Credit Card Number");
		
		if(!validationErrors.hasValidationErrors()){
			validationErrors = ValidatorWrapper.doNumeric(productId,validationErrors,"Product");
			validationErrors = ValidatorWrapper.doInteger(deviceTypeId, validationErrors, "Device Type");
			validationErrors = ValidatorWrapper.doInteger(creditCardNumber,validationErrors,"Credit Card Number");
		}
	...
	private String toXML(){
		...
		if(commissionAmountsHolder != null){
			...
			strBuilder.append(MiniXMLUtil.createXMLParameterTag(CommandFieldConstants.KEY_TX_PROCESS_AMNT,replaceNullWithZero(replaceNullWithZero(commissionAmountsHolder.getTransactionProcessingAmount())).toString()));
