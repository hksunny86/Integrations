...
public class CoreToWalletAdviceCommand extends BaseCommand {
    ...
    public void prepare(BaseWrapper baseWrapper) {
        ...
        try {
            ...
            if(appUserModel != null){
                logger.debug("[CoreToWalletAdviceCommand.execute] AppUserModel loader wil AppUserId:"+appUserModel.getAppUserId());
                ThreadLocalAppUser.setAppUserModel(appUserModel);
            }
        } catch (Exception e) {
            logger.error("[CoreToWalletAdviceCommand.execute] Unable to Load AppUserModel by mobile: " + mobileNo + "\nSetting Default appUserModel in ThreadLocal. appUserId:" + PortalConstants.SCHEDULER_APP_USER_ID+"\n",e);
        }

        logger.debug("End of CoreToWalletAdviceCommand.prepare()");
    ...
    public ValidationErrors validate(ValidationErrors validationErrors) throws CommandException {
        logger.debug("Start of CoreToWalletAdviceCommand.validate()");
        ...
        logger.debug("End of CoreToWalletAdviceCommand.validate()");
    ...
    public void execute() throws CommandException {
        ...
        try {
            ...
            baseWrapper.putObject(CommandFieldConstants.KEY_PROD_ID, ProductConstantsInterface.CORE_TO_WALLET.longValue());
            ...
            if(productVo == null){
                logger.error("[CoreToWalletCommand.execute()] Unable to load productVo. mobileNo:" + mobileNo);
                throw new CommandException("Unable to load productVo", ErrorCodes.COMMAND_EXECUTION_ERROR, ErrorLevel.MEDIUM, null);
            }


            ProductModel productModel = new ProductModel();
            productModel.setProductId(ProductConstantsInterface.CORE_TO_WALLET);
            ...
            transactionTypeModel.setTransactionTypeId(TransactionTypeConstantsInterface.CORE_TO_WALLET_TX);
