...
public class FeePaymentCommand extends BaseCommand {
    ...
    public void prepare(BaseWrapper baseWrapper) {
        if (logger.isDebugEnabled()) {
            logger.debug("Start of FeePaymentApiCommand.prepare()");
        }
    ...
    public ValidationErrors validate(ValidationErrors validationErrors) throws CommandException {
        if (logger.isDebugEnabled()) {
            logger.debug("Start of FeePaymentApiCommand.validate()");
        }
    ...
    public void execute() throws CommandException {
        ...
        try {
            ...
            if (appUserModel != null) {
                ...
                transactionTypeId = TransactionTypeConstantsInterface.FEE_PAYMENT_TX;
                ...
                logger.info("[FeePaymentCommand.execute] Product ID: " + productId + " Logged In AppUserID:" + appUserModel.getAppUserId() +
