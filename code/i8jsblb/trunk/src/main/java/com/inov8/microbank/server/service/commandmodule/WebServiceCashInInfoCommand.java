...
/**
 * Created by Attique on 1/10/2018.
 */
public class WebServiceCashInInfoCommand extends BaseCommand  {
        ...
        baseWrapper = new BaseWrapperImpl();
            ...
            try {
                ...
                if (productModel.getProductIntgModuleInfoId() != null && !"".equals(productModel.getProductIntgModuleInfoId()) && productModel.getProductIntgVoId() != null && !"".equals(productModel.getProductIntgVoId())) {
                    ...
                    customerCNIC = cashInVO.getCustomerCNIC();
                    customerName = cashInVO.getCustomerName();

//									To calculate the commission

                    transactionModel = new TransactionModel();
                    transactionModel.setTransactionAmount(cashInVO.getTransactionAmount());
