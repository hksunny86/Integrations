 ...
 */
public class TransferInDispenser extends BillPaymentProductDispenser {
	...
	public TransferInDispenser(CommissionManager commissionManager, SmartMoneyAccountManager smartMoneyAccountManager, SettlementManager settlementManager, 
...
//				ThreadLocalActionLog.setActionLogId(this.logActionLogModel());
		...
		String accountNumber = switchWrapper.getAccountInfoModel().getAccountNo();
