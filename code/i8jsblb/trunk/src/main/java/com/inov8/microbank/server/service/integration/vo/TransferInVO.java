...
public class TransferInVO implements ProductVO {
	...
	public ProductVO populateVO(ProductVO productVO, BaseWrapper baseWrapper) {
		...
		TransferInVO transferInVO = (TransferInVO) productVO;
		...
		transferInVO.setProductId(productId);
		transferInVO.setAccountId(accountId);
		transferInVO.setDeviceTypeId(deviceTypeId);
		transferInVO.setTxAmount(txAmount);
