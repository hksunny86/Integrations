...
public class BOPCardIssuanceTransaction extends SalesTransaction {
    ...
    private BOPCardIssuanceDAO bopCardIssuanceDAO;
    private ESBAdapter esbAdapter;

    public BOPCardIssuanceTransaction(){
    }
    @Override
    ...
    protected WorkFlowWrapper doPreProcess(WorkFlowWrapper wrapper) throws Exception {
        logger.info("BOPCardIssuanceTransaction.doPreProcess()");
    ...
    public CommissionWrapper calculateCommission(WorkFlowWrapper wrapper) throws Exception {
        logger.info("BOPCardIssuanceTransaction.calculateCommission()");
    ...
    protected WorkFlowWrapper doPreStart(WorkFlowWrapper wrapper) throws Exception {
        ...
        BOPCardIssuanceModel bopCardIssuanceModel = (BOPCardIssuanceModel) wrapper.getBOPCardIssuanceModel();
        wrapper.setBOPCardIssuanceModel(bopCardIssuanceModel);
        bopCardIssuanceDAO.saveOrUpdateBOPCardIssuanceRequest(wrapper);
    ...
    public void setBopCardIssuanceDAO(BOPCardIssuanceDAO bopCardIssuanceDAO) {
        this.bopCardIssuanceDAO = bopCardIssuanceDAO;
    }
