 ...
 */
public class HRACashWithdrawalTransaction extends SalesTransaction{
    ...
    public HRACashWithdrawalTransaction(){
    }
    ...
    public CommissionWrapper calculateCommission(WorkFlowWrapper wrapper) throws Exception {
        if (logger.isDebugEnabled()) {
            logger.debug("Inside calculateCommission(WorkFlowWrapper wrapper) of HraCashWithdrawalTransaction...");
        }
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Ending calculateCommission(WorkFlowWrapper wrapper) of HraCashWithdrawalTransaction...");
        }
    ...
    public void validateCommission(CommissionWrapper commissionWrapper, WorkFlowWrapper workFlowWrapper) throws FrameworkCheckedException {
        if (logger.isDebugEnabled()) {
            logger.debug("Inside validateCommission of HraCashWithdrawalTransaction...");
        }
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Ending validateCommission of HraCashWithdrawalTransaction...");
        }
    }
    ...
    public WorkFlowWrapper doValidate(WorkFlowWrapper wrapper) throws Exception {
        ...
        if (logger.isDebugEnabled())
            logger.debug("Inside doValidate(WorkFlowWrapper wrapper) of HraCashWithdrawalTransaction");
        ...
        if (logger.isDebugEnabled())
            logger.debug("Ending doValidate(WorkFlowWrapper wrapper) of HraCashWithdrawalTransaction");
