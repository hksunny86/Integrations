...
public class ThirdPartyAccountOpeningTransaction extends SalesTransaction {
    ...
    public ThirdPartyAccountOpeningTransaction(){
    }
    ...
    protected WorkFlowWrapper doPreProcess(WorkFlowWrapper wrapper) throws Exception {
        logger.info("ThirdPartyAccountOpeningTransaction.doPreProcess()");
    ...
    public CommissionWrapper calculateCommission(WorkFlowWrapper wrapper) throws Exception {
        logger.info("ThirdPartyAccountOpeningTransaction.calculateCommission()");
    ...
    protected WorkFlowWrapper doPreStart(WorkFlowWrapper wrapper) throws Exception {
        ...
        ThirdPartyAccountOpeningModel thirdPartyAccountOpeningModel = (ThirdPartyAccountOpeningModel) wrapper.getThirdPartyAccountOpeningModel();
        thirdPartyAccountOpeningModel.setStatus(Boolean.TRUE);
        wrapper.setThirdPartyAccountOpeningModel(thirdPartyAccountOpeningModel);
        thirdPartyAcOpeningDAO.saveOrUpdateThirdPartyAcOpeningRequest(wrapper);
