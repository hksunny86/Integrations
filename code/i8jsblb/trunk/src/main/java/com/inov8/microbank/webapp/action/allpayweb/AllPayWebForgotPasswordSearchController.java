...
public class AllPayWebForgotPasswordSearchController extends BaseFormSearchController

{

	private ForgotpinManager forgotPinManager;

	public AllPayWebForgotPasswordSearchController() {
	...
	protected ModelAndView onSearch(HttpServletRequest request,
		...
		forgotpinListViewModel.setDeviceTypeId(DeviceTypeConstantsInterface.ALL_PAY);
