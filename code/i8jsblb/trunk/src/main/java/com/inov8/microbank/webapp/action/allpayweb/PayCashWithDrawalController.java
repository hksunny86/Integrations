...
public class PayCashWithDrawalController extends AdvanceFormController {
	
	private final static Log logger = LogFactory.getLog(PayCashWithDrawalController.class);
	private final String PAGE_FROM = "allpay-web/payCashStepTwo";
	...
	public PayCashWithDrawalController() {
