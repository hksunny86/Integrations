...
public class TransferInController extends AdvanceFormController {
	...
	private final static Log logger = LogFactory.getLog(TransferInController.class);
	...
	protected ModelAndView onCreate(HttpServletRequest request, HttpServletResponse response, Object commandObject, BindException exception) throws Exception {
		...
		*/
		...
		String responseXml = mfsWebController.handleRequest(requestWrapper, CommandFieldConstants.CMD_TRANSFER_IN_INFO);
