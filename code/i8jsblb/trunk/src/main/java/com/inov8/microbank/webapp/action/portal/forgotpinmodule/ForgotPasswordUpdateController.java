 ...
 * Description:				
 */
public class ForgotPasswordUpdateController extends AjaxController
{
	  private ForgotpinManager forgotpinManager;
		...
		public String getResponseContent(HttpServletRequest request, HttpServletResponse response) throws Exception
		{
	    	...
	    	baseWrapper=this.forgotpinManager.updateForgotPassword(baseWrapper);
	    	buffer.append(getMessageSourceAccessor().getMessage("forgotpasswordmodule.new.password.genrated", request.getLocale()));
