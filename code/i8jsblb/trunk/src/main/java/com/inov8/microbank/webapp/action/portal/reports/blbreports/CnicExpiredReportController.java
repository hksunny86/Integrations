...
public class CnicExpiredReportController extends BaseFormSearchController {
    private ReferenceDataManager referenceDataManager;
    private CommonFacade commonFacade;
    private BLBReportsManager blbReportsManager;

    public CnicExpiredReportController()
    {
        super.setCommandName("cnicExpiredViewModel");
        super.setCommandClass(CnicExpiredViewModel.class);
    }
    ...
    protected ModelAndView onSearch(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, PagingHelperModel pagingHelperModel, LinkedHashMap<String, SortingOrder> linkedHashMap) throws Exception {
        CnicExpiredViewModel cnicExpiredViewModel = (CnicExpiredViewModel) o;
        SearchBaseWrapper searchBaseWrapper = new SearchBaseWrapperImpl();
        searchBaseWrapper.setBasePersistableModel(cnicExpiredViewModel);
        searchBaseWrapper.setPagingHelperModel(pagingHelperModel);

        DateRangeHolderModel dateRangeHolderModel = new DateRangeHolderModel( "cnicExpiredOn",
                cnicExpiredViewModel.getStartDate(), cnicExpiredViewModel.getEndDate() );
        searchBaseWrapper.setDateRangeHolderModel(dateRangeHolderModel);

        searchBaseWrapper = blbReportsManager.searchCnicExpiredReport( searchBaseWrapper );
        ...
        return new ModelAndView( successView, "cnicExpiredViewModelList", list );
    }
