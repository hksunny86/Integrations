	...
	<body oncontextmenu="return false">
		<table cellpadding="0" cellspacing="0" height="100%" width="85%" align="center" class="container">
			...
			<tr id="contents" valign="top">
				<td>
					<form name="billpaymentform" method="post" action='<c:url value="/creditCardPaymentStepThree.aw"/>' onsubmit="return validate()">
						<table align="center" width="100%" border="0">
							...
							<tr>
								<td align="right" width="50%">
									<span class="label">Credit Card Number :</span>								</td>
								<td>${param.CCNO}</td>
							</tr>
							<tr>
								<td align="right" width="50%">
									<span class="label">Bill Due Date :</span>								</td>
								<td>${param.BDDATE}</td>
							</tr>							
							<tr>
								<td align="right" width="50%">
							...
							<tr>
								<td align="right" width="50%">
									<span class="label">Outstanding Balance :</span>								</td>
								<td>${param.CCOB}</td>
							</tr>
							<tr>
								<td align="right" width="50%">
							...
							<tr>
								...
								<td><input type="password" maxlength="4" size="4" id="PIN" name="PIN" autocomplete="off"/></td>
							</tr>
							<tr>
								<td align="right"></td>
						...
						<input type='hidden' name='BDDATE' value='${param.BDDATE}'/>
						<input type="hidden" name="TXAM" value="${param.TXAM}"/>
						<input type='hidden' name='MOBN' value='${param.MOBN}'/>
						<input type="hidden" name="PID" value="${param.PID}"/>
						<input type="hidden" name="PNAME" value="${param.PNAME}"/>
						<input type="hidden" name='SID' value="${param.SID}"/>	
						<input type='hidden' name='CCOB' value='${param.CCOB}'/>
						<input type='hidden' name='TPAM' value='${param.TPAM}'/>
						<input type="hidden" name="MAMTF" value="${param.MAMTF}"/><br>	
