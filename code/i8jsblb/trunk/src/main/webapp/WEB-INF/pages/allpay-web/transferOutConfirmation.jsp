	...
	<body oncontextmenu="return false">
		<table cellpadding="0" cellspacing="0" height="100%" width="85%" align="center" class="container">
			...
			<tr id="contents" valign="top">
				<td>
					<form name="billpaymentform" method="post" action='<c:url value="/transferOutConfirmation.aw"/>' onsubmit="return validate()">
						<table align="center" width="100%" border="0">
							...
							<tr>
								<td align="right" width="50%">
									<span class="label">From Account Number (Branchless) :</span>								
								</td>
								<td>${requestScope.BBACCNO}<input type='hidden' name='BBACCNO' value='${requestScope.BBACCNO}'/></td>
							</tr>
							<tr>
								<td align="right" width="50%">
									<span class="label">To Account Number (Core) :</span>								
								</td>
