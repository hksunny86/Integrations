...
<script language="javascript">
	...
	function validate() {
		...
		}else if(AMT.value % 50 != 0){
			return writeError('Amount entered must be multiple of 50.');
		}
	...
	<body oncontextmenu="return false">
		<table cellpadding="0" cellspacing="0" height="100%" width="85%" align="center" class="container">
			...
			<tr id="contents" valign="top">
				<td>
					<form name="billpaymentform" method="post" action='<c:url value="/ubpServiceStepTwo.aw"/>' onsubmit="return validate()">
						<table align="center" width="100%" border="0">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;&nbsp;${requestScope.CSCD}<input type='hidden' name='CSCD' value='${requestScope.CSCD}'>
							...
							<c:choose>
								<c:when test="${(param.PID!=2510744 && param.PID!=2510747)}">
									<tr>
										...
										<td>&nbsp;&nbsp;&nbsp;${requestScope.TAMTF}<input type='hidden' name='TAMTF' value='${requestScope.TAMTF}'></td>
									</tr>
									<tr>
										<td align="right" width="50%">
											<span class="label">Billing Month :</span></td>
										<td>&nbsp;&nbsp;&nbsp;${requestScope.BDATE}<input type='hidden' name='BDATE' value='${requestScope.BDATE}'></td>
									</tr>
								</c:when>
								<c:otherwise>
									<tr>
							...
							<tr>
								...
								<td><input type="text" id="AMT" name="AMT" maxlength="20" size="11" 
							...
							<tr>
								...
								<td><input type="text" id="CDCUSTMOB" name="CDCUSTMOB" maxlength="11" size="11" 
										style="-wap-input-format: '*N'; -wap-input-required: true" class="text" /></td>
							</tr>
							<tr>
								<td align="right">
