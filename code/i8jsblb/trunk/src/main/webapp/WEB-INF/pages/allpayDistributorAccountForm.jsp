...
<meta name="decorator" content="decorator">
		...
		<meta name="title" content="New Agent Contact" />
...
{
	document.forms.allpayDistributorAccountForm.managingContactId.value='';
	document.forms.allpayDistributorAccountForm.managingContactFirstName.value='';
}
...
function popupCallback(src,popupName,columnHashMap)
{
  ...
  if(src=="levelName")
  {
    document.forms.allpayDistributorAccountForm.distributorLevelId.value = columnHashMap.get('PK');
    document.forms.allpayDistributorAccountForm.levelName.value = columnHashMap.get('name');
  }
  if(src=="managingContactFirstName")
  {
    document.forms.allpayDistributorAccountForm.managingContactId.value = columnHashMap.get('PK');
    document.forms.allpayDistributorAccountForm.managingContactFirstName.value = columnHashMap.get('firstName')+' ' +columnHashMap.get('lastName');
  }
 if(src=="areaName")
  {
    document.forms.allpayDistributorAccountForm.areaId.value = columnHashMap.get('PK');
    document.forms.allpayDistributorAccountForm.areaName.value = columnHashMap.get('name');
    
    // Clear all other popups value
    document.forms.allpayDistributorAccountForm.distributorId.value = '';
    document.forms.allpayDistributorAccountForm.distributorName.value = '';
    
    document.forms.allpayDistributorAccountForm.distributorLevelId.value = '';
    document.forms.allpayDistributorAccountForm.levelName.value = '';
  }
}
function toggleLevel()
{
	...
	{
		document.forms.allpayDistributorAccountForm.distributorLevelId.value=level;
		document.forms.allpayDistributorAccountForm.distributorLevelId.disabled = true;
		document.forms.allpayDistributorAccountForm.distributorLevel.value=level;
		
	}
	else if (document.forms[0].head.checked == false)
	{
		
		document.forms.allpayDistributorAccountForm.distributorLevelId.disabled = false;
	}
}
//window.onload= setFocus();
function setFocus(){
document.forms.allpayDistributorAccountForm.areaId.focus();
}
</script>
		<script type="text/javascript"
	...
	<body  >
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
			<form id="allpayDistributorAccountForm" method="post"
				action="allpayDistributorAccountForm.html"
				...
				<c:if test="${not empty param.distributorContactId}">
					...
					<spring:bind path="distributorContactModel.oldNic">
						<input type="hidden" name="${status.expression}"
							value="${status.value}" />
					</spring:bind>
				...
				<input type="hidden" name="<%=PortalConstants.KEY_USECASE_ID%>"
					value="<%=PortalConstants.DISTRIBUTOR_CONTACT_FORM_USECASE_ID%>" />
				...
				<spring:bind
					path="distributorContactModel.distributorContactModelVersionNo">
					<input type="hidden" name="${status.expression}"
						value="${status.value}" />
				</spring:bind>
				...
				<td align="left">
					<spring:bind path="distributorContactModel.areaId">
						<select name="${status.expression}" class="textBox"
							id="${status.expression}" class="textBox"
							<c:if test="${not empty param.distributorContactId}">disabled='disabled'</c:if>>
					...
					<spring:bind path="distributorContactModel.distributorLevelId">
						<select name="${status.expression}" class="textBox"
							...
							<c:if test="${not empty distributorLevelModelList}">
								<c:forEach items="${distributorLevelModelList}"
									var="distributorLevelModelList">
			...
			<tr>
				...
				<td width="50%" align="left" bgcolor="FBFBFB">
					<c:if
						test="${not empty distributorContactModel.managingContactName}">

						<input type="text" name="managingContactFirstName"
							readonly="readonly" class="textBox"
							value="${distributorContactModel.managingContactName}" />
						<input name="contactLookupButton" type="button" value="-o"
							class="button"
							style="height: 17px;width: 17px;text-align: center"
							onClick="javascript:callLookup('managingContactFirstName','distributorContactPopup',400,200,'distributorContactPopup.distributorId='+ document.forms.allpayDistributorAccountForm.distributorId.value+'&distributorContactPopup.accountEnabled=1')" />
					</c:if>
					<c:if test="${empty distributorContactModel.managingContactName}">

						<input type="text" name="managingContactFirstName"
							readonly="readonly" class="textBox"
							value="${param.managingContactFirstName}" />
						<input name="contactLookupButton" type="button" value="-o"
							class="button"
							style="height: 17px;width: 17px;text-align: center"
							onClick="javascript:callLookup('managingContactFirstName','distributorContactPopup',400,200,'distributorContactPopup.distributorId='+ document.forms.allpayDistributorAccountForm.distributorId.value+'&distributorContactPopup.accountEnabled=1')" />
					</c:if>
					<img title="Clear Managing Contact"
						onclick="clearManagingContact()" style="cursor:pointer"
			...
			<tr bgcolor="#FBFBFB">
				<td width="50%" align="right" bgcolor="F3F3F3" class="formText">
					<span style="color:#FF0000">*</span>AllPay Id:&nbsp;
				</td>
				<td width="50%" align="left">
					<spring:bind path="distributorContactModel.allpayId">

						<input type="text" name="${status.expression}"
							value="${status.value}" class="textBox" maxlength="12"
							onkeypress="return maskNumber(this,event)"
							<c:if test="${not empty param.distributorContactId}">readonly="readOnly" </c:if> />
					</spring:bind>
				</td>
				<%--          </tr> --%>
				<%--            <tr bgcolor="#FBFBFB" >--%>
				<%--            <td width="50%" align="right" bgcolor="F3F3F3" class="formText"><span style="color:#FF0000">*</span>Account Nick:&nbsp;</td>--%>
				<%--            <td width="50%" align="left">--%>
				<%--		    <spring:bind path="distributorContactModel.accountNick">--%>
			...
			<tr bgcolor="#FBFBFB">
				<td width="50%" align="right" bgcolor="F3F3F3" class="formText">
					<span style="color:#FF0000">*</span>Middle Name:&nbsp;
				</td>
				<td width="50%" align="left">
					<spring:bind path="distributorContactModel.middleName">
						<input type="text" name="${status.expression}"
							value="${status.value}"
							onkeypress="return maskAlphaWithSp(this,event)" class="textBox"
							maxlength="50" />
			...
			<tr bgcolor="FBFBFB">
				<td align="right" bgcolor="F3F3F3" class="formText">
					<span style="color: rgb(255, 0, 0);">*</span>Father Name:&nbsp;
				</td>
				<td align="left">
					<spring:bind path="distributorContactModel.fatherName">
			...
			<tr bgcolor="FBFBFB">
				...
				<td>
					<spring:bind path="distributorContactModel.username">
						<c:choose>
			...
			<tr bgcolor="FBFBFB">
				...
				<td>
					<spring:bind path="distributorContactModel.password">
			...
			<tr bgcolor="FBFBFB">
				...
				<td>
					<spring:bind path="distributorContactModel.passwordHint">
						<input type="text" name="${status.expression}" class="textBox"
			...
			<tr bgcolor="#FBFBFB">
				<td width="50%" align="right" bgcolor="F3F3F3" class="formText">
					<span style="color:#FF0000">*</span>Landline No:&nbsp;
				</td>
				<td width="50%" align="left">
					<spring:bind path="distributorContactModel.landlineNumber">
						<input type="text" name="${status.expression}"
							value="${status.value}"
							onkeypress="return maskNumber(this,event)" class="textBox"
							maxlength="10" />
			...
			<tr bgcolor="FBFBFB">
				<td align="right" bgcolor="F3F3F3" class="formText">
					<span style="color: rgb(255, 0, 0);">*</span>Date of Birth:&nbsp;
				</td>
				<td>
					<spring:bind path="distributorContactModel.dob">
						<input type="text" name="${status.expression}" class="textBox"
							id="${status.expression}" maxlength="50" value="${status.value}"
							readonly="readonly" />
					</spring:bind>
			...
			<tr bgcolor="FBFBFB">
				<td align="right" bgcolor="F3F3F3" class="formText">
					<span style="color: rgb(255, 0, 0);">*</span>NIC:&nbsp;
				</td>
				<td>
					<spring:bind path="distributorContactModel.nic">
						<input type="text" name="${status.expression}"
							onkeypress="return maskNumber(this,event)" class="textBox"
			...
			<tr bgcolor="#FBFBFB">
				<td width="50%" align="right" bgcolor="F3F3F3" class="formText">
					<span style="color: rgb(255, 0, 0);">*</span>Address 1:&nbsp;
				</td>
				<td width="50%" align="left">
					<spring:bind path="distributorContactModel.address1">
						<input type="text" name="${status.expression}"
							value="${status.value}" class="textBox"
							onkeypress="return maskCommon(this,event)" maxlength="250" />
					</spring:bind>
			...
			<spring:bind path="distributorContactModel.balance">
				<c:if test="${empty param.distributorContactId}">
					<input type="hidden" name="${status.expression}" value="0.0" />
				</c:if>
				<c:if test="${not empty param.distributorContactId}">
					<input type="hidden" name="${status.expression}"
						value="${status.value}" />
			...
			<tr>
				<td width="50%" align="right" bgcolor="F3F3F3" class="formText">
					<span style="color:#FF0000"></span>Account Status:&nbsp;
				</td>
				<td width="50%" align="left" bgcolor="FBFBFB">
					<spring:bind path="distributorContactModel.accountStatusId">
						<select name="${status.expression}" class="textBox"
							id="${status.expression}">
							<option value="1"
								<c:if test="${status.value == 1}">selected="selected"</c:if> />
								Active
							</option>
							<option value="2"
								<c:if test="${status.value == 2}">selected="selected"</c:if> />
								Inactive
							</option>
							<option value="3"
								<c:if test="${status.value == 3}">selected="selected"</c:if> />
								Blocked
							</option>
						</select>
					</spring:bind>
			...
			<tr>
				...
				<td align="left" bgcolor="FBFBFB">
					<spring:bind path="distributorContactModel.description">
						<textarea name="${status.expression}" cols="50" rows="5"
							onkeyup="textAreaLengthCounter(this,250);"
							onkeypress="return maskCommon(this,event)" class="textBox"
			...
			<tr>
				...
				<td align="left" bgcolor="FBFBFB">
					<spring:bind path="distributorContactModel.comments">
						<textarea name="${status.expression}"
							onkeyup="textAreaLengthCounter(this,250);"
							onkeypress="return maskCommon(this,event)" cols="50" rows="5"
...
<spring:bind path="distributorContactModel.head">
<input type = "hidden" name = "originalHeadValue" value = "${status.value }"/>
</spring:bind>
			<%--<tr>--%>
			<%--    <td width="49%" height="16" align="right" bgcolor="F3F3F3" class="formText">Commissioned:&nbsp;</td>--%>
			<%--    <td width="51%" align="left" bgcolor="FBFBFB" class="formText">--%>
			<%--    <spring:bind path="distributorContactModel.commissioned">--%>
			<%--	    <input name="${status.expression}" type="checkbox" value="true" 	--%>
			<%--	    <c:if test="${status.value==true}">checked="checked"</c:if>	--%>
			<%--	     />			    --%>
			<%--     </spring:bind>--%>
			...
			<tr bgcolor="FBFBFB">
				<td colspan="2" align="center">
					...
					<input type="button" name="_save" value="  Save  "
						onclick="javascript:onSave(document.forms.allpayDistributorAccountForm,null);"
						class="button" />
					<c:if test="${empty param.distributorContactId}">
						<input type="button" name="_cancel" value=" Cancel "
							onclick="javascript:revertDropdowns(document.forms.allpayDistributorAccountForm);"
							class="button" />
					</c:if>
					<c:if test="${not empty param.distributorContactId}">
						<input type="button" name="_cancel" value=" Cancel "
							class="button"
							onclick="javascript:revertDropdownsLevel(document.forms.allpayDistributorAccountForm);" />
					</c:if>
				</td>
			</tr>
		</table>
		...
		<ajax:select source="areaId" target="distributorId"
			...
			parameters="areaId={areaId},actionType=1" errorFunction="error"
		...
		<ajax:select source="distributorId" target="partnerGroupId"
			...
			parameters="id={distributorId},appUserTypeId=4,actionType=2"
			errorFunction="error" />



		<ajax:updateField source="distributorId" eventType="click"
			action="head" target="head,distributorLevelId"
			parser="new ResponseXmlParser()" postFunction="toggleLevel"
			baseUrl="${contextPath}/distributorcontactformrefdata.html"
  	...
  	Form.focusFirstElement($('allpayDistributorAccountForm'));
...
{	
   /*if(!validateFormChar(theForm)){
     ...
     if (document.forms.allpayDistributorAccountForm.allpayId.value==''){
  			alert("Allpay Id is a required field");
		   document.forms.allpayDistributorAccountForm.allpayId.focus();
		   return false;
  	}
//  	if (document.forms.allpayDistributorAccountForm.accountNick.value==''){
//  			alert("Account nick is a required field");
//		   document.forms.allpayDistributorAccountForm.accountNick.focus();
//		   return false;
// 	}
  	if (document.forms.allpayDistributorAccountForm.middleName.value==''){
  			alert("Middle name is a required field");
		   document.forms.allpayDistributorAccountForm.middleName.focus();
		   return false;
  	}
  	if (document.forms.allpayDistributorAccountForm.fatherName.value==''){
  			alert("Father name is a required field");
		   document.forms.allpayDistributorAccountForm.fatherName.focus();
		   return false;
  	}
  	if (document.forms.allpayDistributorAccountForm.landlineNumber.value==''){
  			alert("Landline number is a required field");
		   document.forms.allpayDistributorAccountForm.landlineNumber.focus();
		   return false;
  	}
  	if (document.forms.allpayDistributorAccountForm.nic.value==''){
  			alert("NIC is a required field");
		   document.forms.allpayDistributorAccountForm.nic.focus();
		   return false;
  	}
  		if (document.forms.allpayDistributorAccountForm.address1.value==''){
  			alert("Address1 is a required field");
		   document.forms.allpayDistributorAccountForm.address1.focus();
		   return false;
  	}
  	  		if (document.forms.allpayDistributorAccountForm.dob.value==''){
   ...
   if( trim(theForm.dob.value) != '' && isDateGreater(theForm.dob.value,currServerDate)){
	...
	if( document.forms.allpayDistributorAccountForm.isUpdate != null && document.forms.allpayDistributorAccountForm.isUpdate.value == 'true' )
  	{
	
		if( document.forms.allpayDistributorAccountForm.password.value == document.forms.allpayDistributorAccountForm.confirmPassword.value )
		{
			if( document.forms.allpayDistributorAccountForm.managingContactId.value != '' && 
  		 document.forms.allpayDistributorAccountForm.head.checked )
  		 {
  		 	alert("Contact under a Manager cannot be a Head ");
  		 	return false;
  		 }
  		 else
			return validateDistributorContactModel(document.forms.allpayDistributorAccountForm);
	 	}	 
  	...
  	else if( document.forms.allpayDistributorAccountForm.password.value == document.forms.allpayDistributorAccountForm.confirmPassword.value )
	{
		if( document.forms.allpayDistributorAccountForm.password.value == '' )
	    {
		   alert("Password and Confirm Password is required");
		   document.forms.allpayDistributorAccountForm.password.focus();
		   return false;
	    }
		if( document.forms.allpayDistributorAccountForm.managingContactId.value != '' && 
  		   document.forms.allpayDistributorAccountForm.head.checked )
...
Calendar.setup(
      {
		...
		<v:javascript formName="distributorContactModel"
