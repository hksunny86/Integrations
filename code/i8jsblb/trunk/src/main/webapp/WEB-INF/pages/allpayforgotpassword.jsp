		...
		<html:form name="mnoforgotPin" commandName="forgotpinListViewModel" onsubmit="return validateForm()" >
	  				...
	  				<tr>
	       				<td width="33%"  align="right" class="formText">Agent ID:</td>
	      					<td width="17%"  align="left"><html:input onkeypress="return maskCommon(this,event)" tabindex="1"  path="userId" cssClass="textBox" maxlength="12"/></td>
					...
					<tr>
			          ...
			          <security:isauthorized action="<%=PortalConstants.ACTION_RETRIEVE%>">
					    ...
					    <input type="reset" tabindex="4" name="cancel" value="Cancel" class="button" onclick="javascript:window.location='allpayforgotpassword.html?actionId=${retriveAction}'"/></td>
						<td  align="left">&nbsp;</td>
						<td  align="left">&nbsp;
						</td>		
			...
			<ec:table filterable="false"
				...
				action="${pageContext.request.contextPath}/allpayforgotpassword.html?actionId=${retriveAction}"
				title="">
				...
				<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_CSV_READ%>">
  				...
  				<ec:row>
    				...
    				<ec:column property="userId" filterable="false" title="Agent ID" escapeAutoFormat="true"/>
					...
					<input type="hidden" value="${forgotpinListAppUserId}" name="appUser${forgotpinListAppUserId}" id="appUser${forgotpinListAppUserId}" />
						...
						<ajax:htmlContent baseUrl="${contextPath}/allpayforgotpassword.html" 
							eventType="click" 
