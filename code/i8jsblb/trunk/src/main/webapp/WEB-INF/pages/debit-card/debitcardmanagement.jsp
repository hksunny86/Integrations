...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function openTransactionDetailWindow(transactionCode) {
            var action = 'p_showtransactiondetail.html?actionId='+${retriveAction}+
            '&transactionCodeId=' + transactionCode + '&isMfs=true';
    ...
    <table width="100%" border="0">
        ...
        <tr>
            ...
            <td align="left">
                <html:select path="cardProductCodeId" cssClass="textBox" tabindex="6">
                    ...
                    <c:if test="${cardProductTypeList != null}">
                        <html:options items="${cardProductTypeList}" itemValue="cardProductCodeId"
                                      itemLabel="cardProductName"/>
                    </c:if>
                </html:select>
            </td>
            ...
            <td width="58%" align="left">
                ...
                <html:select path="reissuance" cssClass="textBox" tabindex="13"
        ...
        <tr>
            ...
            <td align="left">
                <html:input path="createdOnStartDate" id="createdOnFromDate" readonly="true" tabindex="-1"
            ...
            <td align="left">
                <html:input path="createdOnEndDate" id="createdOnToDate" readonly="true" tabindex="-1"
                            cssClass="textBox" maxlength="10"/>
        ...
        <tr>
            ...
            <td align="left">
                <html:input path="reIssuancecreatedOnStartDate" id="reissuanceCreatedOnFromDate" readonly="true"
                            tabindex="-1" cssClass="textBox" maxlength="10"/>
                <img id="ReIssuanceCreatedFromDate" tabindex="11" name="popcal" align="top" style="cursor:pointer"
                     src="images/cal.gif" border="0"/>
                <img id="ReIssuanceCreatedFromDate" tabindex="13" title="Clear Date" name="popcal"
                     onclick="javascript:$('reissuanceCreatedOnFromDate').value=''" align="middle"
            ...
            <td align="left">
                <html:input path="reIssuancecreatedOnEndDate" id="reissuanceCreatedOnToDate" readonly="true"
                            tabindex="-1" cssClass="textBox" maxlength="10"/>
                <img id="ReIssuanceCreatedToDate" tabindex="13" name="popcal" align="top" style="cursor:pointer"
                     src="images/cal.gif" border="0"/>
                <img id="ReIssuanceCreatedToDate" tabindex="14" title="Clear Date" name="popcal"
                     onclick="javascript:$('reissuanceCreatedOnToDate').value=''" align="middle" style="cursor:pointer"
                     src="images/refresh.png" border="0"/>
            </td>
        </tr>
...
<ec:table items="debitCardRequestsList" var="debitCardRequestsViewModel"
    ...
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
        <ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
                      headerTitle="Debit Card Requests"
    ...
    <ec:row>
        ...
        <ec:column property="cardProductType" title="Card Product Type" escapeAutoFormat="True"
        ...
        <c:choose>
            <c:when test="${debitCardRequestsViewModel.isReIssuanceApprovedDenied ne 1 }">
                <ec:column property="isReIssuanceApprovedDenied" title="Re-Issuance Approval Denied"
                           escapeAutoFormat="true" value="No"/>
            </c:when>
            <c:otherwise>
                <ec:column property="isReIssuanceApprovedDenied" title="Re-Issuance Approval Denied"
                           escapeAutoFormat="true" value="Yes"/>
            </c:otherwise>
        </c:choose>
        ...
        <c:choose>
            <c:when test="${debitCardRequestsViewModel.isReIssuanceApproved ne 1 }">
                <ec:column property="isReIssuanceApproved" title="Re-Issuance Approved" escapeAutoFormat="true"
                           value="No"/>
            </c:when>
            <c:otherwise>
                <ec:column property="isReIssuanceApproved" title="Re-Issuance Approved" escapeAutoFormat="true"
        ...
        <ec:column property="reissuanceRequestDate" cell="date" format="dd/MM/yyyy hh:mm a"
                   title="Re-Issuance Request Date"/>
        ...
        <ec:column alias=" " viewsAllowed="html" filterable="false" sortable="false">
            <p style="color: red">*<select id="cardCity" tabindex="2" cssClass="textBox">
                <option value="0" label="---All---"></option>
                <option value="1" label="Islamabad"></option>
                <option value="1" label="Karachi"></option>
            </select>
            </p>
        ...
        debitCardRequestsViewModel.isApprovedDenied ne 1}">
                            ...
                            <input type="button" class="button" style="width='90px'" value="Change Info"
                                   onclick="
                                           javascript:changeInfo('${contextPath}/debitcardchangeinfoform.html?debitCardId=${debitCardRequestsViewModel.debitCardId}');
        ...
        debitCardRequestsViewModel.isReIssuanceApprovedDenied ne 1}">
                        ...
                        <c:otherwise>
                            <input type="button" class="button" disabled="disabled" style="width='90px'"
                                   value="Change Info"
                                   onclick="javascript:changeInfo('${contextPath}/debitcardchangeinfoform.html?debitCardId=${debitCardRequestsViewModel.debitCardId}');"/>
                        </c:otherwise>
                    </c:choose>
        ...
        debitCardRequestsViewModel.isApprovedDenied ne 1}">
                            <input type="button" class="button" value="Approve"
                                   id="btnretry_${debitCardRequestsViewModel.debitCardId}"/>
                        </c:when>

                        <c:when test="${debitCardRequestsViewModel.reissuance eq 1 and debitCardRequestsViewModel.isReIssuanceApproved ne 1 and
        debitCardRequestsViewModel.isReIssuanceApprovedDenied ne 1}">
                            <input type="button" class="button" onclick="pageReload()" value="Approve"
                                   id="btnretry_${debitCardRequestsViewModel.debitCardId}"/>
                        </c:when>

                        <c:otherwise>
                            <input type="button" class="button" disabled="disabled" value="Approve"
                                   id="btnretry_${debitCardRequestsViewModel.debitCardId}"/>
                        </c:otherwise>
                    </c:choose>
                </c:when>
            ...
            <c:choose>
                <c:when test="${debitCardRequestsViewModel.cardStatusId ne 2}">
                    <c:choose>
                        <c:when test="${debitCardRequestsViewModel.reissuance ne 1 and debitCardRequestsViewModel.isApproved ne 1 and
        debitCardRequestsViewModel.isApprovedDenied ne 1}">
                            <input type="button" class="button" value="Approval Denied"
                                   id="btndeny_${debitCardRequestsViewModel.debitCardId}"/>
                        </c:when>
        ...
        debitCardRequestsViewModel.isReIssuanceApprovedDenied ne 1}">
                        ...
                        <c:otherwise>
                            <input type="button" class="button" disabled="disabled" value="Approval Denied"
                                   id="btndeny_${debitCardRequestsViewModel.debitCardId}"/>
                        </c:otherwise>
                    </c:choose>
                </c:when>
