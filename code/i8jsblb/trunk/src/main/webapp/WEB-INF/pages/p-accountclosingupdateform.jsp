    ...
    <c:otherwise>
        <div class="eXtremeTable">
            <table class="tableRegion" width="100%">
                <tr class="titleRow">
                    <td>
                        <html:form name="closingForm" id="closingForm" commandName="appUserModel"
                                   action="p-accountclosingupdateform.html" method="post" onsubmit="return validate()">
                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                ...
                                <tr>
                                    <td width="49%" height="16" align="right" bgcolor="F3F3F3" class="formText">Customer
                                        ID:&nbsp;&nbsp;
                                    </td>
                                    <td width="51%" align="left" bgcolor="FBFBFB">
                                        <input type="text" name="customerId" value="${appUserModel.customerId}"
                                               class="textBox" readonly="readonly" size="15"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" bgcolor="FBFBFB">
                                        <c:if test="${ not appUserModel.accountClosedUnsettled}">
                                            <html:textarea path="closingComments"
                                                           onkeypress="return maskCommon(this,event)" cssClass="textBox"
                                                           rows="6"
                                                           cssStyle="overflow: auto; width: 163px; height: 102px;"></html:textarea>
                                            <input type="hidden" name="isClosed" id="isClosed"
                                                   value="appUserModel.accountClosedUnsettled"/>
                                        </c:if>
                                        <c:if test="${appUserModel.accountClosedUnsettled}">
                                            <html:textarea path="settlementComments"
                                                           onkeypress="return maskCommon(this,event)" cssClass="textBox"
                                                           rows="6"
                                                           cssStyle="overflow: auto; width: 163px; height: 102px;"></html:textarea>
                                            <input type="hidden" name="isClosed" id="isClosed"
                                                   value="accountClosedUnsettled"/>
                                        </c:if>
                                    </td>
                                </tr>
                                <tr bgcolor="FBFBFB">
                                ...
                                <tr>
                                    <input type="hidden" path="appUserId" name="appUserId"
                                           value="${appUserModel.appUserId}"/>
                                    <input type="hidden" name="isUpdate" id="isUpdate" value="true"/>

                                    <td align="center" colspan="2">
                                        <input name="_save" id="saveButton" type="submit" class="button"
