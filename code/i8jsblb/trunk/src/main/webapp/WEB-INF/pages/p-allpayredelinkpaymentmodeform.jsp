...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="title" content="De/Re Link Payment Mode"/>
	...
	<h3 class="header" id="logHeader">
		<c:if test="${param.usecaseId eq '1007' or param.usecaseId eq '1112' }">
				De/Re Link Payment Mode
		</c:if>
		<c:if test="${param.usecaseId eq '1079'}">
				Delete Payment Mode
		</c:if>
	</h3>
	...
	<div class="eXtremeTable">
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<form id="allpayredelinkpaymentmodeform" method="post" action="p-allpayredelinkpaymentmodeform.html" onsubmit="return validateForm(this)"  >
								<table width="100%"  border="0" cellpadding="0" cellspacing="1">
							        ...
							        <tr>
							            <td width="49%" height="16" align="right" bgcolor="F3F3F3" class="formText"><span style="color:#FF0000">*</span>Agent ID :&nbsp;</td>
							            <td width="51%" align="left" bgcolor="FBFBFB">
							          
							                <input name="transactionCode" type="text" size="40" readonly="readonly" class="textBox" tabindex="0" maxlength="50"  value="${param.mfsId}"  />       
							          </tr>
							        <tr>
							        ...
							        <input type="hidden" name="actionId" value="${param.actionId}">
							         <input type="hidden" name="smAcId" value="${param.smAcId}">
									<input type="hidden" name="apUsrId" value="${param.apUsrId}">
									<input type="hidden" name="isDeleted" value="${param.isDeleted}">
