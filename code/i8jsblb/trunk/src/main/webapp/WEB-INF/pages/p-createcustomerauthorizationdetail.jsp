...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="approvedOrDenied" value="true" scope="page" />
		   		...
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-createcustomerauthorizationdetail.html" method="post" onsubmit="return onFormSubmit()">
			...
			<table  class="tableRegion" width="100%">
				<tr> 
					...
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.accounttypeName }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Registration State</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.regStateName}</td>
				</tr>
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.regStateComments }</td>
				</tr>
				<tr>
              		<td colspan="4" align="center" bgcolor="FBFBFB">
						<h3>
							L0 / L1 Account Opening Form
						</h3>
					</td>
                </tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Mobile No.</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.mobileNo }</td>
				</tr>
				<tr>
                		<td colspan="4" align="center" bgcolor="FBFBFB">
								<h5>
				...
				<tr>	
					...
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.name }</td>
				
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Customer Picture</td>
				...
				<tr>	
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">CNIC Front</td>
					<td width="25%" height="16" align="left"  class="formText">
					...
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">CNIC Back</td>
					<td width="25%" height="16" align="left"  class="formText">
				...
				<tr>	
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Terms and Condition Picture</td>
					<td width="25%" height="16" align="left"  class="formText">
					...
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Signature Picture</td>
					<td width="25%" height="16" align="left"  class="formText">
				...
				<c:if test="${mfsAccountModel.customerAccountTypeId == 2}">
					<tr>	
						<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Level 1 Form Picture</td>
						<td width="25%" height="16" align="left"  class="formText">
				...
				<tr>	
					...
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.nic}</td>
				...
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Original CNIC Seen</td>
					<td width="25%" height="16" align="left"  class="formText">
						Yes
					</td>
				</tr>
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.birthPlaceName }</td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.fatherHusbandName }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Mother's Maiden Name</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.motherMaidenName }</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Mailing Address</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.presentAddress }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">City</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.permanentHomeAddCityName }</td>
				</tr>
				<tr>
					<c:if test="${mfsAccountModel.customerAccountTypeId == 2}">
						<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Email</td>
						<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.email }</td>
					</c:if>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Segment</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.segmentNameStr }</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Tax Regime</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.taxRegimeName }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">FED(%age)</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.fed }</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Porduct Catalog</td>
					<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.productCatalogName }</td>
					
				</tr>
				
				<c:if test="${mfsAccountModel.customerAccountTypeId == 2}">
					<tr>
						<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Source of Funds</td>
						<td width="25%" height="16" align="left"  class="formText">
				...
				<c:if test="${mfsAccountModel.customerAccountTypeId == 2}">
					...
					<tr>
						<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Name</td>
						<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.nokName }</td>
						
						<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Relationship</td>
						<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.nokRelationship }</td>
					</tr>	
					<tr>	
						<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">CNIC</td>
						<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.nokNic }</td>
						
						<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Address</td>
						<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.nokMailingAdd }</td>
					</tr>
					<tr>	
						<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Mobile No</td>
						<td width="25%" height="16" align="left"  class="formText">${mfsAccountModel.nokMobile }</td>
					</tr>
				</c:if>
				<tr>	
