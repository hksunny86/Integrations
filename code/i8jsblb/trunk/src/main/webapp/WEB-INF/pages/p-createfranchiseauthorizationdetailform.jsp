...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="title" content="Create Franchise Authorization Detail"/>
	...
	<c:set var="approvedOrDenied" value="true" scope="page" />
		   		...
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-createfranchiseauthorizationdetailform.html" method="post" onsubmit="return validate()">
			...
			<table>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${retailerModel.active }</td>
