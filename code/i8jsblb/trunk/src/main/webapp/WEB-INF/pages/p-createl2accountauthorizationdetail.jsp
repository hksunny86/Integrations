...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="approvedOrDenied" value="true" scope="page" />
		   		...
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-createl2accountauthorizationdetail.html" method="post" onsubmit="return onFormSubmit()">
			...
			<h3 class="header" id="detailHeader">Customer Details </h3>
			<table  class="tableRegion" width="100%">
				<tr> 
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Type of Account</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.accounttypeName }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Registration State</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.regStateName}</td>
				</tr>
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText"><fmt:formatDate  type="both" 
            			dateStyle="short" timeStyle="short" value="${level2AccountModel.createdOn}" /></td>
				
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Reg.State Comments</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.regStateComments }</td>
				</tr>
				<tr>
              		<td colspan="4" align="center" bgcolor="FBFBFB">
						<h3>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.initialAppFormNo }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Mobile No.</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.mobileNo }</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Account Title</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.customerAccountName }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Segment</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.segmentName }</td>
				</tr>
				<tr>
                	<td colspan="4" align="center" bgcolor="FBFBFB">
                ...
                <tr>	
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.accountPurpose }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Nature of Account</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.acNatureName }</td>
				</tr>
				<tr>	
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Account Title</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.customerAccountName }</td>
				...
				<tr>	
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.taxRegimeName }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">FED (%age)</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.fed }</td>
				</tr>
				<tr>	
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Product Catalog</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.productCatalogName }</td>
				...
				<tr>	
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.titleTxt}</td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.name}</td>
				</tr>
				<tr>	
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">ID Document Type</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.idTypeName}</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">ID Document Number</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.idNumber}</td> 
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.birthPlaceName }</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">NTN</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.ntn }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Mother's Maiden Name</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.motherMaidenName }</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.nationality}</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Phone Number</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.landLineNo }</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Home Number</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.contactNo}</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Fax</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.fax}</td>
				</tr>
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.email}</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Father/Husband Name</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.fatherHusbandName}</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Name of Employeer/Business</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.employerName}</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Occupation</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.occupationName}</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Profession</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.professionName}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.buisnessAddress }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Business City</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.buisnessCityName }</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Residential Address</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.residentialAddress }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Residential City</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.residentialCityName }</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Marital Status</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.applicant1DetailModel.maritalStatusName}</td>
				</tr>
				<tr>
					<td colspan="4" align="center" bgcolor="FBFBFB">
						<h5>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.nokDetailVOModel.nokName }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Relationship with KIN</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.nokDetailVOModel.nokRelationship}</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Telephone/Mobile Number of KIN</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.nokDetailVOModel.nokContactNo }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">ID Document Type</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.nokDetailVOModel.nokIdTypeName}</td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">ID Document Number</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.nokDetailVOModel.nokIdNumber }</td>
					
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Next of KIN Address</td>
					<td width="25%" height="16" align="left"  class="formText">${level2AccountModel.nokDetailVOModel.nokMailingAdd}</td>
				</tr>
			</table> 
