...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="title" content="Action Authorization Detail"/>
	...
	<c:set var="approvedOrDenied" value="true" scope="page" />
		   		...
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-lockunlockaccountauthorizationdetail.html" method="post" onsubmit="return validate()">
						       <table width="100%" border="0" cellpadding="0" cellspacing="1">
						           ...
						           <tr>
						            ...
						            <tr>
						             <td width="49%" height="16" align="right" bgcolor="F3F3F3" class="formText"><c:if test="${isAgent }">Agent ID</c:if><c:if test="${isAgent eq 'false'}">Customer ID</c:if>:&nbsp;&nbsp;</td>
						             <td width="51%" align="left" bgcolor="FBFBFB">
										 <input type="text" name="transactionId" class="textBox" maxlength="14" value="${mfsId}" readonly="readonly"/>
						             </td>
						           </tr>
