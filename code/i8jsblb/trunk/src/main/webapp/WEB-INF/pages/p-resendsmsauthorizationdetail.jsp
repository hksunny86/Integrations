...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="approvedOrDenied" value="true" scope="page" />
		   		...
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-resendsmsauthorizationdetail.html" method="post" onsubmit="return validate()">
						       <table width="100%" border="0" cellpadding="0" cellspacing="1">
						           ...
						           <tr>
						            ...
						            <tr>
						             ...
						             <td width="51%" align="left" bgcolor="FBFBFB">
										 <input type="text" name="transactionId" class="textBox" maxlength="14" value="${transactionCode}" readonly="readonly"/>
						             </td>
						           </tr>
