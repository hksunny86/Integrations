...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="eXtremeTable">
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<form id="resetTransactionCodeForm" method="post" action="p-resendsmsform.html" onsubmit="return validateForm(this)"  >
								<table width="100%"  border="0" cellpadding="0" cellspacing="2">
																	
									<input type="hidden" name="isUpdate" id="isUpdate" value="true"/>
									<input type="hidden" name="usecaseId" id="usecaseId" value="<%=PortalConstants.RESEND_SMS_USECASE_ID%>"</>
							        ...
							        <tr>
							            <td  width="49%" height="16" align="right" bgcolor="F3F3F3" class="formText"><span style="color:#FF0000">*</span>Transaction ID :&nbsp;</td>
							            <td align="left" bgcolor="FBFBFB">
							          
							                <input name="transactionCode" type="text" size="40" readonly="readonly" class="textBox" tabindex="0" maxlength="50"  value="${param.txCode }"  />       
							          </tr>
							        <tr>
							        ...
							        <input type="hidden" name="resendSmsStrategy" value="${param.resendSmsStrategy}">
							         <input type="hidden" name="transactionId" value="${param.tId}">
