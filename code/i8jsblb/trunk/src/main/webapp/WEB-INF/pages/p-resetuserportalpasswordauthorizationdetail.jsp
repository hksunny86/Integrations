...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="title" content="Reset Portal Password Authorization Detail"/>
	...
	<c:otherwise>
	 ...
	 <c:if test="${(actionAuthorizationModel.actionStatusId == 3) || (actionAuthorizationModel.actionStatusId == 5) || (actionAuthorizationModel.actionStatusId == 6) || (actionAuthorizationModel.actionStatusId == 7)|| (actionAuthorizationModel.actionStatusId == 8)}">
	<c:set var="approvedOrDenied" value="true" scope="page" />
	</c:if>	
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-resetuserportalpasswordauthorizationdetail.html" method="post" onsubmit="return validate()">
						       <table width="100%" border="0" cellpadding="0" cellspacing="1">
						           ...
						           <c:if test="${isAgent }">
						            ...
						            <tr>
						             <td width="49%" height="16" align="right" bgcolor="F3F3F3" class="formText">Agent Id:&nbsp;&nbsp;</td>
						             <td width="51%" align="left" bgcolor="FBFBFB">
										 <input type="text" name="mfsId" class="textBox" maxlength="14" value="${mfsId}" readonly="readonly"/>
						             </td>
						           </tr>
						           </c:if>
						            <c:if test="${not isAgent}">					           
						            <tr>
						             <td width="49%" height="16" align="right" bgcolor="F3F3F3" class="formText">User Name:&nbsp;&nbsp;</td>
						             <td width="51%" align="left" bgcolor="FBFBFB">
										 <input type="text" name="username" class="textBox" maxlength="14" value="${username}" readonly="readonly"/>
						             </td>
						           </tr>
						           </c:if>
