...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="eXtremeTable">
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "closingForm" id = "closingForm" commandName="appUserModel" action="p-retaileraccountclosingform.html" method="post" onsubmit="return validate()">
						       <table width="100%" border="0" cellpadding="0" cellspacing="1">
						           ...
						           <tr>
						             ...
						             <td width="51%" align="left" bgcolor="FBFBFB">
										<input type="text" name="customerId" value="${appUserModel.retailerContactId}" class="textBox" readonly="readonly" size="15"/>
						             </td>
						           </tr>
						           <tr>
