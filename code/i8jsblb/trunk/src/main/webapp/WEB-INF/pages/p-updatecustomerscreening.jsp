...
<html>
  ...
  <body bgcolor="#ffffff">
<%--     <spring:bind  path="bulkUpdateCustomerScreeningModel">
  	 <c:if test="${not empty status.errorMessages}">
    	...
    	<html:form name="bulkUpdateCustomerScreeningForm" commandName="bulkUpdateCustomerScreeningModel" enctype="multipart/form-data" method="POST"
				action="p-updatecustomerscreening.html">
						...
						<tr>
							...
							<td align="left">
								<input type="button" name="_save" value="  Preview  " tabindex="2"
									onclick="javascript:onFormSubmit(document.forms.bulkUpdateCustomerScreeningForm);" class="button" />
							</td>
						</tr>
					</table>
			</html:form>
    		...
    		<script language="javascript" type="text/javascript">
			 ...
			 function onFormSubmit(theForm){ 
      			if(document.forms.bulkUpdateCustomerScreeningForm.csvFile.value == ''){
      			alert("File Location is required.");
      			return false;
      	}
      		if(!document.forms.bulkUpdateCustomerScreeningForm.csvFile.value.endsWith('.csv')){
          	...
          	return false;
	   		 ...
	   		 onSave(document.forms.bulkUpdateCustomerScreeningForm);
      }
