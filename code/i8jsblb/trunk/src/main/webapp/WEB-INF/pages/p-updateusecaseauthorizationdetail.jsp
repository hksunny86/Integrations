...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="title" content="Update User Authorization Detail"/>
	...
	<c:set var="approvedOrDenied" value="true" scope="page" />
		   		...
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-updateusecaseauthorizationdetail.html" method="post" onsubmit="return validate()">
						       <table width="100%" border="0" cellpadding="0" cellspacing="1">
						         ...
						         <c:if test="${isAssignedBack}">
									...
									<tr>
						         		<td align="center" colspan="2">	
						        			<input name="modify" type="button" class="button" value=" Modify " onclick="window.open('p_usecasemanagementform.html?isReSubmit=true&authId='+${actionAuthorizationModel.actionAuthorizationId}+'&actionId=1','_blank');window.close();"/>
						        		</td>			        		
						        	</tr>					        							
								</c:if>	
						           <tr bgcolor="FBFBFB">
			...
			<h3 class="header" id="detailHeader">
				<td colspan="2" width="25%">New State</td>
			</h3>
			<table class="tableRegion" width="100%">
				<tr> 
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Usecase Name</td>
					<td width="25%" height="16" align="left"  class="formText">${usecaseModel.name }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Escalation Levels</td>
					<td width="25%" height="16" align="left"  class="formText">${usecaseModel.escalationLevels }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Description</td>
					<td width="25%" height="16" align="left"  class="formText">${usecaseModel.description}</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${usecaseModel.comments}</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
					
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Active Authorization</td>
					<td width="25%" height="16" align="left"  class="formText">${usecaseModel.authorizationStatus }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
					
				</tr>
				<c:if test="${usecaseModel.escalationLevels>0}">
					<c:forEach var="i" begin="0" end="${usecaseModel.escalationLevels-1}">
   						<tr>
							
							<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Level ${i} Checkers</td>
							<td width="25%" height="16" align="left"  class="formText">${usecaseModel.levelcheckers[i]}</td>
							<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Intimate Only</td>
							<td width="25%" height="16" align="left"  class="formText">${usecaseModel.usecaseIdLevelModelList[i].intimateOnly }</td>
						</tr>
			...
			<h3 class="header" id="detailHeader">Old State</h3>
			<table class="tableRegion" width="100%">
				<tr> 
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Usecase Name</td>
					<td width="25%" height="16" align="left"  class="formText">${currentUsecaseModel.name }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Escalation Levels</td>
					<td width="25%" height="16" align="left"  class="formText">${currentUsecaseModel.escalationLevels }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
				</tr>
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Description</td>
					<td width="25%" height="16" align="left"  class="formText">${currentUsecaseModel.description}</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
				...
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Comments</td>
					<td width="25%" height="16" align="left"  class="formText">${currentUsecaseModel.comments}</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
				...
				<tr>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Active Authorization</td>
					<td width="25%" height="16" align="left"  class="formText">${currentUsecaseModel.authorizationStatus }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText"></td>
					<td width="25%" height="16" align="left"  class="formText"></td>
					
				</tr>
				<c:if test="${currentUsecaseModel.escalationLevels>0}">
					<c:forEach var="i" begin="0" end="${currentUsecaseModel.escalationLevels-1}">
   						<tr>
							
							<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Level ${i} Checkers</td>
							<td width="25%" height="16" align="left"  class="formText">${currentUsecaseModel.levelcheckers[i]}</td>
							<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Intimate Only</td>
							<td width="25%" height="16" align="left"  class="formText">${currentUsecaseModel.usecaseIdLevelModelList[i].intimateOnly }</td>
						</tr>				
					</c:forEach>
				</c:if>
			</table>  
