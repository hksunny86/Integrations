...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="approvedOrDenied" value="true" scope="page" />
		   		...
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-updateuserauthorizationdetailform.html" method="post" onsubmit="return validate()">
						       <table width="100%" border="0" cellpadding="0" cellspacing="1">
						         ...
						         <c:if test="${isAssignedBack}">
									...
									<tr>
						         		<td align="center" colspan="2">	
						        			<input name="modify" type="button" class="button" value=" Modify " onclick="window.open('p_i8userformtest.html?isReSubmit=true&authId='+${actionAuthorizationModel.actionAuthorizationId}+'&actionId=1','_blank');window.close();"/>
						        		</td>			        		
						        	</tr>					        							
								</c:if>	
						           <tr bgcolor="FBFBFB">
			...
			<table class="tableRegion" width="100%">
				<tr>
					<td colspan="2" width="25%"><h3 class="header" id="detailHeader">Old State</h3></td>
					<td colspan="2" width="25%"><h3 class="header" id="detailHeader">New State</h3> </td>
				</tr>
				<tr> 
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">User Type</td>
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.appUserType }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">User Type</td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.partnerType }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Partner</td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.partnerGroup}</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Partner Group</td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.employeeId}</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Employee ID</td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.firstName }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">First Name</td>
				...
				<tr>	
					...
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.lastName }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Last Name</td>
				...
				<tr>	
					...
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.userId }</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">User ID</td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.email}</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Email</td>
				...
				<tr>	
					...
					<td width="25%" height="16" align="left"  class="formText"><fmt:formatDate  type="DATE" dateStyle="short" pattern="dd-MM-yyyy" value="${currentUserModel.dob}" /></td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">DOB</td>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">
						<c:choose>	
							<c:when test="${fn:startsWith(currentUserModel.mobileNo, 'U')}"></c:when>
						    <c:otherwise>
						    ${currentUserModel.mobileNo }  
						    </c:otherwise>
						</c:choose>
					</td>
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Mobile No</td>
					<td width="25%" height="16" align="left"  class="formText">
						<c:choose>	
							<c:when test="${fn:startsWith(userModel.mobileNo, 'U')}"></c:when>
						    <c:otherwise>
						    ${userModel.mobileNo }  
						    </c:otherwise>
						</c:choose>
				...
				<tr>
					...
					<td width="25%" height="16" align="left"  class="formText">${currentUserModel.isActiveStatus }</td>	
					<td width="25%" height="16" align="left" bgcolor="F3F3F3" class="formText">Status</td>
					<td width="25%" height="16" align="left"  class="formText">${userModel.isActiveStatus }</td>	
				</tr>			
			</table> 
