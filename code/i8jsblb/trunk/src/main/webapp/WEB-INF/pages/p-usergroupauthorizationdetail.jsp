...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="title" content="User Group Authorization Detail"/>
	...
	<c:set var="approvedOrDenied" value="true" scope="page" />
		   		...
		   		<table class="tableRegion" width="100%">
					<tr class="titleRow">
						<td>	
							<html:form  name = "actionDetailForm" id = "actionDetailForm" commandName="actionAuthorizationModel" action="p-usergroupauthorizationdetail.html" method="post" onsubmit="return validate()">
						       <table width="100%" border="0" cellpadding="0" cellspacing="1">
						           ...
						           <tr>
						             <td width="49%" height="16" align="right" bgcolor="F3F3F3" class="formText">Group Name:&nbsp;&nbsp;</td>
						             <td width="51%" align="left" bgcolor="FBFBFB">
										 <input type="text" name="mfsId" class="textBox" maxlength="14" value="${groupName}" readonly="readonly"/>				
						             </td>
						           </tr>
						           ...
						           <tr>
							           ...
							           <td align="center" colspan="2">
							           	<input name="New State" type="button" class="button" value=" New State " onclick="javascript:doModify('p_partnergroupform.html?isReadOnly=true&isNew=true&authId='+${actionAuthorizationModel.actionAuthorizationId}+'&actionId=1');"/>
						         		<input name="Old State" type="button" class="button" value=" Old State " onclick="javascript:doModify('p_partnergroupform.html?isReadOnly=true&isNew=false&authId='+${actionAuthorizationModel.actionAuthorizationId}+'&actionId=1');"/>							         			
						         ...
						         <c:if test="${isAssignedBack}">
									...
									<tr>														       
						         		<td align="center" colspan="2">	
						         			<input name="New State" type="button" class="button" value=" Detail " onclick="javascript:doModify('p_partnergroupform.html?isReadOnly=true&isNew=true&authId='+${actionAuthorizationModel.actionAuthorizationId}+'&actionId=1');"/>
						         			<input name="Old State" type="button" class="button" value=" Detail " onclick="javascript:doModify('p_partnergroupform.html?isReadOnly=true&isNew=false&authId='+${actionAuthorizationModel.actionAuthorizationId}+'&actionId=1');"/>							         			
						        			<input name="modify" type="button" class="button" value=" Modify " onclick="javascript:doModify('p_partnergroupform.html?isReSubmit=true&authId='+${actionAuthorizationModel.actionAuthorizationId}+'&actionId=1');window.close();"/>
						        		</td>			        		
						        	</tr>					        							
								</c:if>	
						           <tr bgcolor="FBFBFB">
