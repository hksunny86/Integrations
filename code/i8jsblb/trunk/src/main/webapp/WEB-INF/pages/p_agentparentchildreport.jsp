...
<head>
    ...
    <meta name="title" content="Parent Agent Child Report" />
...
<html:form name="agentParentChildReportForm" commandName="agentParentChildReportModel" method="post"
           action="p_agentparentchildreport.html" onsubmit="return validateForm(this)">
    <table width="1000px" border="0">
        <tr>
            ...
            <td align="left">
                <html:input path="parentAgentId" cssClass="textBox" maxlength="10" tabindex="1" onkeypress="return maskNumber(this,event)"/>
            </td>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input name="reset" type="reset"
                       onclick="javascript: window.location='p_agentparentchildreport.html?actionId=${retriveAction}'"
...
<ec:table items="agentParentChildReportModelList" var="agentParentChildReportModel"
          retrieveRowsCallback="limit" filterRowsCallback="limit"
          sortRowsCallback="limit" action="${contextPath}/p_agentparentchildreport.html?actionId=${retriveAction}"
          title="" width="100%" filterable="false" sortable="true">

    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLS_READ%>">
        <ec:exportXls fileName="Agent Parent Child Report.xls" tooltip="Export Excel" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLSX_READ%>">
        <ec:exportXlsx fileName="Agent Parent Child Report.xlsx" tooltip="Export Excel" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
        <ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
                      headerTitle="Agent Parent Child Report" fileName="Agent Parent Child Report.pdf" tooltip="Export PDF" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_CSV_READ%>">
        <ec:exportCsv fileName="Agent Parent Child Report.csv" tooltip="Export CSV"></ec:exportCsv>
    </authz:authorize>
    <ec:row>
        <%--        <c:set var="appUserId">--%>
        <%--            <security:encrypt strToEncrypt="${bdeKpiReportViewModel.appUserId}"></security:encrypt>--%>
        <%--        </c:set>--%>
        <ec:column title="Parent Agent Id" property="parentAgentId"/>
        ...
        <ec:column title="Child Agent ID" property="childAgentId"/>
        <ec:column title="Account Opening Date" property="accountOpeningDate"/>
