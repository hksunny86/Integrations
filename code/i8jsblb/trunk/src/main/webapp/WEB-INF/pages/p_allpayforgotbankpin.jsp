...
<meta name="decorator" content="decorator">
	<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/commonFormValidator.js"></script>
		<link rel="stylesheet"
			...
			type="text/css">
		<meta name="title" content="AllPay Forgot Bank PIN" />
	...
	<body bgcolor="#ffffff">
		...
		<table width="100%">
			<html:form name="forgotVeriflyPinForm"
				action="p_allpayforgotbankpin.html" method="post"
				...
				<tr>
				  <td class="formText" align="right"> AllPay ID: </td>
					<td align="left">
					<c:choose>
						<c:when test="${not empty param.fromAppUserId}">
							<html:input tabindex="3" readonly="true" path="mfsId" onkeypress="return maskCommon(this,event)" cssClass="textBox" maxlength="12" />
						</c:when>					
						<c:otherwise>
							<html:input tabindex="3" path="mfsId" onkeypress="return maskCommon(this,event)" cssClass="textBox" maxlength="12" />
						</c:otherwise>
					</c:choose>
					</td>
					<td align="left">&nbsp;</td>
		...
		<ec:table filterable="false" width="100%" 
			...
			action="${pageContext.request.contextPath}/p_allpayforgotbankpin.html"
			title="">

			<authz:authorize ifAnyGranted="<%=PortalConstants.EXP_RPT_PDF_XLS_READ%>">
				<ec:exportXls fileName="AllPay Forgot Bank PIN.xls" tooltip="Export Excel" />
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLSX_READ%>">
				<ec:exportXlsx fileName="AllPay Forgot Bank PIN.xlsx" tooltip="Export Excel" />
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
				<ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
					headerTitle="AllPay Forgot Bank PIN" fileName="AllPay Forgot Bank PIN.pdf" tooltip="Export PDF" />
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_CSV_READ%>">
				<ec:exportCsv fileName="AllPay Forgot Bank PIN.csv" tooltip="Export CSV"></ec:exportCsv>
			</authz:authorize>
			...
			<ec:row>
				...
				<ec:column property="mfsId" title="AllPay ID" sortable="true" filterable="false" width="10%" />
