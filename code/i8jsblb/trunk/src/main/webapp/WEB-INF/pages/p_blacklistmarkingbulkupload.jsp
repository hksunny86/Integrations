...
<head>
    ...
    <meta name="title" content="Blacklist Marking Bulk Upload" />
                ...
                function($)
                {
                    ...
                    $( "#btnSave" ).click(
                            function() {
                                 ...
                                 if( isValidForm )
                                 {
                                     $("#blacklistMarkingBulkUploadVoForm").submit();
                                 }
                                 return isValidForm;
                            });
...
<html:form id="blacklistMarkingBulkUploadVoForm" commandName="blacklistMarkingBulkUploadVo" enctype="multipart/form-data"
           method="POST" action="p_blacklistmarkingbulkupload.html">
    <table width="100%" border="0" cellpadding="0" cellspacing="1">

        <tr style="height: 35px">
            <td align="right" bgcolor="F3F3F3" class="formText"
                width="25%">
                <span style="color: #FF0000">*</span>Blacklisted:
            </td>
            <td align="left" bgcolor="FBFBFB" width="50%">
                <html:radiobuttons tabindex="27" items="${blacklistMarkingList}" itemLabel="label" itemValue="value" path="isBlacklisted" />
            </td>
        </tr>
        <tr><td> </td><td></td></tr>
        <tr>
            ...
            <td bgcolor="FBFBFB" class="text">
                <spring:bind path="blacklistMarkingBulkUploadVo.csvFile">
