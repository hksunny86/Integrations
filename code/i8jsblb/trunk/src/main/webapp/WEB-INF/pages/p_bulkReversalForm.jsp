...
<head>
    ...
    <meta name="title" content="Bulk Reversal Report" />
...
<html:form name='bulkReversalForm'
           commandName="bulkAutoReversalModel" method="post"
           action="p_bulkReversalForm.html" onsubmit="return validateForm(this)" >
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input name="reset" type="reset"
                       onclick="javascript: window.location='p_bulkReversalForm.html?actionId=${retriveAction}'"
...
<ec:table items="bulkAutoReversalModelList" var="bulkAutoReversalModel"
          action="${contextPath}/p_bulkReversalForm.html?actionId=${retriveAction}"
          title=""
    ...
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLS_READ%>">
        <ec:exportXls fileName="Bulk Reversal Report.xls" tooltip="Export Excel" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLSX_READ%>">
        <ec:exportXlsx fileName="Bulk Reversal Report.xlsx" tooltip="Export Excel" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
        <ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
                      headerTitle="Transaction Details"
                      fileName="Bulk Reversal Report.pdf" tooltip="Export PDF" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_CSV_READ%>">
        <ec:exportCsv fileName="Bulk Reversal Report.csv" tooltip="Export CSV"></ec:exportCsv>
    </authz:authorize>
    ...
    <ec:row>
        <ec:column property="trxnId" title="Transaction ID" escapeAutoFormat="true">
            <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_TRX_DETAIL_POPUP%>">
                <a href="p_transactionissuehistorymanagement.html?actionId=${retriveAction}&transactionCode=${bulkAutoReversalModel.trxnId}" onClick="return openTransactionWindow('${bulkAutoReversalModel.trxnId}')">
