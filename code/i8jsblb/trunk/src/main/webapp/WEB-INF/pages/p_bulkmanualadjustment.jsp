...
<html>
  <head>
   <%--  <base href="<%=basePath%>"> --%>
    <title>Bulk Manaual Adjustment</title>
  ...
  <body>
   <body bgcolor="#ffffff">
		...
		<spring:bind path="bulkManualAdjustmentModel">
		...
		<c:if test="${not empty messages}">
			...
			<html:form name="bulkManualAdjustmentForm" commandName="bulkManualAdjustmentModel" enctype="multipart/form-data" method="POST"
				action="p_bulkmanualadjustment.html">
						...
						<tr>
							...
							<td align="left">
								<input type="button" name="_save" value="  Preview  " tabindex="2"
									onclick="javascript:onFormSubmit(document.forms.bulkManualAdjustmentForm);" class="button" />
							</td>
						</tr>
					</table>
			</html:form>
			...
			<script language="javascript" type="text/javascript">
			 function onFormSubmit(theForm){ 
      			if(document.forms.bulkManualAdjustmentForm.csvFile.value == ''){
      			alert("Manual Adjustment File Location is required.");
      			return false;
      	}
      		if(!document.forms.bulkManualAdjustmentForm.csvFile.value.endsWith('.csv')){
        ...
        // }
	   		 ...
	   		 onSave(document.forms.bulkManualAdjustmentForm,null);
      }
