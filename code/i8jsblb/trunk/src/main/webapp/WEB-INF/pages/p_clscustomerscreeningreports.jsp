...
<body>
	...
	<ec:table items="bookMeList" var="bookMeList" action="${contextPath}/p_clsscreeningreports.html" title="" retrieveRowsCallback="limit"
		...
		<ec:row>
			...
			<ec:column property="clsResponseCode" title="Case Status" escapeAutoFormat="true"/>
			...
			<ec:column property="createdOn" title="Account Updated On" escapeAutoFormat="true" cell="date" format="dd/MM/yyyy hh:mm a" />
