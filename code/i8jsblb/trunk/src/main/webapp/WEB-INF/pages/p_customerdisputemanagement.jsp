	...
	<body bgcolor="#ffffff" onunload="javascript:closeChild();">
		...
		<table width="100%">
			<html:form name='customerDisputeForm'
				commandName="extendedCustDisputeTranBlPmListViewModel" method="post"
				action="p_customerdisputemanagement.html"
				...
				<tr>
					...
					<td width="17%" align="left">
						<html:input onkeypress="return maskCommon(this,event)"
							path="mfsId" id="mfsId" cssClass="textBox" maxlength="8"
							tabindex="1" />
						${status.errorMessage}
					</td>
				...
				<tr>
					...
					<td align="left">
						...
						<html:input onkeypress="return maskCommon(this,event)"
							path="issueCode" id="issueCode" cssClass="textBox" maxlength="50"
							tabindex="3" />
						${status.errorMessage}
					...
					<td align="left">
						<html:input path="startDate" tabindex="-1" readonly="true"
							id="startDate" cssClass="textBox" maxlength="10" />
				...
				<tr>
					...
					<td align="left">
						<html:input path="endDate" id="endDate" tabindex="-1"
							readonly="true" cssClass="textBox" maxlength="10" />
						<img id="eDate" tabindex="6" name="popcal" align="top"
							style="cursor:pointer" src="images/cal.gif" border="0" />
						<img id="eDate" tabindex="7" title="Clear Date" name="popcal"
				...
				<tr>
					...
					<td align="left">
						...
						<html:select path="productId" cssClass="textBox" tabindex="8">
							...
							<c:if test="${custDisputeServiceList != null}">
								<html:options items="${custDisputeServiceList}"
				...
				<tr>
					...
					<td align="left">
						<span class="formText"> <input type="hidden"
								name="<%=PortalConstants.KEY_ACTION_ID%>"
								value="<%=PortalConstants.ACTION_RETRIEVE%>" /> <security:isauthorized
								action="<%=PortalConstants.ACTION_RETRIEVE%>">
								<jsp:attribute name="ifAccessAllowed">
									<input name="_search" type="submit" class="button"
										value="Search" tabindex="9" />
								</jsp:attribute>
							...
							<input name="reset" type="reset" class="button" value="Cancel"
								tabindex="10"
								onclick="javascript: window.location='p_customerdisputemanagement.html?actionId=${retriveAction}'" />
						</span>
					</td>
					<td colspan="2">
						&nbsp;
		...
		<ec:table filterable="false" items="customerDisputeList"
			var="custDisputeTransModel"
			action="${pageContext.request.contextPath}/p_customerdisputemanagement.html?actionId=${retriveAction}"
			...
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
				<ec:exportPdf headerBackgroundColor="#b6c2da" headerTitle="Customer Dispute"
					view="com.inov8.microbank.common.util.CustomPdfView" fileName="Customer Dispute.pdf" tooltip="Export PDF" />
			</authz:authorize>
			...
			<c:set var="custDisputeTransIssueTypeStatusId">
				...
				<ec:column property="issueCode" filterable="false"
					title="Issue Code" style="width:">
					...
					<security:isauthorized
						...
						<jsp:attribute name="ifAccessAllowed">
							<a href="p_issuehistorymanagement.html"
								onclick="return openIssueWindow('${custDisputeTransModel.issueCode}')">
								<c:out value="${custDisputeTransModel.issueCode}"></c:out> </a>
						</jsp:attribute>
						<jsp:attribute name="ifAccessNotAllowed">
				...
				<ec:column property="transactionCode" filterable="false"
					...
					<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_TRX_DETAIL_POPUP%>">
							<a href="p_transactionissuehistorymanagement.html?actionId=${retriveAction}&transactionCode=${custDisputeTransModel.transactionCode}"
								onclick="return openTransactionWindow('${custDisputeTransModel.transactionCode}')">
				...
				<ec:column property="productName" filterable="false" alias="Service" />
				...
				<ec:column property="rifc" title="RIFC" style="text-align: center"
					...
					<c:if
						test="${custDisputeTransIssueTypeStatusId == RIFC || custDisputeTransIssueTypeStatusId == INOV8_RIFC}">YES</c:if>&nbsp;
		       </ec:column>

				<ec:column property="invalid" title="In-Valid" filterable="false"
					...
					<c:if
						test="${custDisputeTransIssueTypeStatusId == INVALID || custDisputeTransIssueTypeStatusId == INOV8_INVALID}">YES</c:if>&nbsp;
		       </ec:column>

				<ec:column property="i8" title="Escalate To Inov8"
					filterable="false" style="text-align: center" sortable="false">
					<c:if test="${custDisputeTransIssueTypeStatusId == NEW}">
		...
		<form name="issueForm" action="">
			...
			<table width="85%">
				...
				<tr>
					...
					<td align="left" width="75%">
						<input type="text" tabindex="11"
							onkeypress="return maskNumber(this,event)" id="issueMfsId"
							class="textBox" maxlength="8" />
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left" width="75%">
						<input type="text" tabindex="12"
							onkeypress="return maskCommon(this,event)" id="custTransCode"
				...
				<tr>
					...
					<td align="left" width="75%">
						<textarea id="comments" tabindex="13"
							onkeypress="return maskCommon(this,event)" class="textBox"
							cols="50" rows="5" style="overflow: auto"></textarea>
					</td>
				</tr>
				<tr>
					<td align="left">
					...
					<td align="left">
						...
						<security:isauthorized
							action="<%=PortalConstants.ACTION_DEFAULT%>">
							<jsp:attribute name="ifAccessAllowed">
								<input id="btnSubmit" tabindex="14" type="button" class="button"
									value="Escalate to Inov8" onclick="submitIssue()" />
							</jsp:attribute>
							<jsp:attribute name="ifAccessNotAllowed">
								<input id="btnSubmit" tabindex="-1" type="button" class="button"
									value="Escalate to Inov8" disabled="disabled" />
							</jsp:attribute>
						</security:isauthorized>
