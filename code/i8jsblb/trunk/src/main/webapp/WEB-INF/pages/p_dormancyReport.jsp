...
<head>
    ...
    <meta name="title" content="Dormancy Report" />
...
<html:form name="dormancyReportForm" commandName="dormancyReportViewModel" method="post"
           action="p_dormancyReport.html" onsubmit="return validateForm(this)">
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input name="reset" type="reset"
                       onclick="javascript: window.location='p_dormancyReport.html?actionId=${retriveAction}'"
...
<ec:table items="dormancyReportViewModelList" var="dormancyReportViewModel"
          retrieveRowsCallback="limit" filterRowsCallback="limit"
          sortRowsCallback="limit" action="${contextPath}/p_dormancyReport.html?actionId=${retriveAction}"
          title="" width="100%" filterable="false" sortable="true">

    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLS_READ%>">
        <ec:exportXls fileName="Dormancy Report.xls" tooltip="Export Excel" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLSX_READ%>">
        <ec:exportXlsx fileName="Dormancy Report.xlsx" tooltip="Export Excel" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
        <ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
                      headerTitle="Dormancy Report" fileName="Dormancy Report.pdf" tooltip="Export PDF" />
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_CSV_READ%>">
        <ec:exportCsv fileName="Dormancy Report.csv" tooltip="Export CSV"></ec:exportCsv>
    </authz:authorize>
    <ec:row>
        <%--        <c:set var="appUserId">--%>
        ...
        <ec:column title="Account Aging" property="accountAging"/>
        <ec:column title="Dormancy Due On" property="dormancyDueOn" cell="date" format="yyyy-MM-dd"/>
