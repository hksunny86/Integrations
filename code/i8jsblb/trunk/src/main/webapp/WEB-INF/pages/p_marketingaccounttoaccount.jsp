	...
	<body bgcolor="#ffffff">
		<c:if test="${not empty messages}">
			...
			<html:form name='transactionDetailI8Form' commandName="extendedTransactionDetailPortalListModel" method="post"
				action="p_marketingaccounttoaccount.html" onsubmit="return validateForm(this)" >
				...
				<tr>
					...
					<td align="left">
						<html:input path="recipientMobileNo" id="recipientMobileNo" cssClass="textBox" maxlength="11" tabindex="3" onkeypress="return maskNumber(this,event)"/>
					</td>
				</tr>
				<tr>
					...
					<td align="left">
					     ...
					     <img id="eDate" tabindex="6" name="popcal" align="top" style="cursor:pointer" src="images/cal.gif" border="0" />
					     <img id="eDate" tabindex="7" title="Clear Date" name="popcal" onclick="javascript:$('endDate').value=''" align="middle" style="cursor:pointer" src="images/refresh.png" border="0" />
					</td>
				</tr>
				<tr>
					<td class="formText" align="right">
					...
					<td align="left">
						...
						<input name="reset" type="reset"
							onclick="javascript: window.location='p_marketingaccounttoaccount.html?actionId=${retriveAction}&reportType=${param.reportType}'"
		...
		action="${contextPath}/p_marketingaccounttoaccount.html?actionId=${retriveAction}"
		title="" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" filterable="false">
			...
			<ec:row>
				...
				<ec:column property="recipientMobileNo" filterable="false" title="Destination MSISDN" escapeAutoFormat="True" style="text-align: center"/>
