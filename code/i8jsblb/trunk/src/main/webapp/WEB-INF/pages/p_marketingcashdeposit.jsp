	...
	<body bgcolor="#ffffff">
		<c:if test="${not empty messages}">
			...
			<html:form name='transactionDetailI8Form' commandName="extendedTransactionDetailPortalListModel" method="post"
				action="p_marketingcashdeposit.html" onsubmit="return validateForm(this)" >
				...
				<tr>
					...
					<td align="left">
						...
						<input name="reset" type="reset"
							onclick="javascript: window.location='p_marketingcashdeposit.html?actionId=${retriveAction}&reportType=${param.reportType}'"
		...
		action="${contextPath}/p_marketingcashdeposit.html?actionId=${retriveAction}"
