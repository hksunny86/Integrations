	...
	<body bgcolor="#ffffff">
		<c:if test="${not empty messages}">
			...
			<html:form name='transactionDetailI8Form' commandName="extendedTransactionDetailPortalListModel" method="post"
				action="p_marketingcashwithdrawal.html" onsubmit="return validateForm(this)" >
				...
				<tr>
					...
					<td align="left" width="32%">
						<html:input path="agent1MobileNo" id="agent1MobileNo" cssClass="textBox" maxlength="11" tabindex="3" onkeypress="return maskNumber(this,event)"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left">
						...
						<input name="reset" type="reset"
							onclick="javascript: window.location='p_marketingcashwithdrawal.html?actionId=${retriveAction}&reportType=${param.reportType}'"
		...
		action="${contextPath}/p_marketingcashwithdrawal.html?actionId=${retriveAction}&reportType=${param.reportType}"
		title="" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" filterable="false">
			...
			<ec:row>
				...
				<ec:column property="recipientMobileNo" filterable="false" title="MSISDN" escapeAutoFormat="true" style="text-align: center"/>
                <ec:column property="agent1Id" filterable="false" title="Agent ID" escapeAutoFormat="true" style="text-align: center"/>
                <ec:column property="agentBusinessName" filterable="false" title="Business Name" escapeAutoFormat="true" style="text-align: center"/>
				<ec:column property="productName" filterable="false" title="Transaction"/>
				<ec:column property="agent1MobileNo" filterable="false" title="Agent MSISDN" escapeAutoFormat="true" style="text-align: center"/>
