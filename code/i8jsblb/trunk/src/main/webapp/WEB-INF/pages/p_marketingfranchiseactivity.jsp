...
<meta name="decorator" content="decorator">
		...
		<meta name="title" content="Franchise Activity Report" />
	...
	<body bgcolor="#ffffff">
		<c:if test="${not empty messages}">
			...
			<html:form name='retailerTransactionViewForm' commandName="extendedRetailerTransactionViewModel" method="post"
				action="p_marketingfranchiseactivity.html" onsubmit="return validateForm(this);" >
				...
				<tr>
					...
					<td align="left" width="32%">
						<html:input path="senderRetailerName" id="senderRetailerName" cssClass="textBox" maxlength="20" tabindex="3"/>
					</td>
					<td align="right" class="formText" width="18%">
						Receiver Franchise:
					</td>
					<td align="left">
						<html:input path="receiverRetailerName" id="receiverRetailerName" cssClass="textBox" maxlength="20" tabindex="4"/>
					</td>
				</tr>
				<tr>
					<td align="right" class="formText">
				...
				<tr>
					...
					<td align="left">
						...
						<img id="sDate" tabindex="7" name="popcal" align="top" style="cursor:pointer" src="${contextPath}/images/cal.gif" border="0"/>
						<img id="sDate" tabindex="8" title="Clear Date" name="popcal" onclick="javascript:$('startDate').value=''" align="middle" style="cursor:pointer" src="${contextPath}/images/refresh.png" border="0" />
					</td>
					<td align="right" class="formText">
						End Date:
					</td>
		...
		<ec:table items="retailerTransactionViewModelList" var="retailerTransactionViewModel" action="${contextPath}/p_marketingfranchiseactivity.html?actionId=${retriveAction}"
			title="" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" filterable="false">
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLS_READ%>">
				<ec:exportXls fileName="Franchise Activity Report.xls" tooltip="Export Excel"/>
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLSX_READ%>">
				<ec:exportXlsx fileName="Franchise Activity Report.xlsx" tooltip="Export Excel" />
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
				<ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
				headerTitle="Franchise Activity Report" fileName="Franchise Activity Report.pdf" tooltip="Export PDF" />
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_CSV_READ%>">
				<ec:exportCsv fileName="Franchise Activity Report.csv" tooltip="Export CSV"></ec:exportCsv>
			</authz:authorize>	
			<ec:row>
				...
				<ec:column property="senderRetailerName" title="Sender Franchise" style="text-align: center"/>
				<ec:column property="receiverRetailerName" title="Receiver Franchise" style="text-align: center"/>
