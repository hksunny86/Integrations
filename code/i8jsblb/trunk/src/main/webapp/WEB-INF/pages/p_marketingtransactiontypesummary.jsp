...
<meta name="decorator" content="decorator">
		...
		<meta name="title" content="Transaction Type Summary Report"/>
	...
	<body bgcolor="#ffffff">
		<c:if test="${not empty messages}">
			...
			<html:form name='transactionDetailI8Form' commandName="extendedTransactionDetailPortalListModel" method="post"
				action="p_marketingtransactiontypesummary.html" onsubmit="return validateForm(this)" >
				...
				<tr>
					...
					<td align="left">
						...
						<input name="reset" type="reset"
							onclick="javascript: window.location='p_marketingtransactiontypesummary.html?actionId=${retriveAction}'"
		...
		action="${contextPath}/p_marketingtransactiontypesummary.html?actionId=${retriveAction}"
		title="" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" filterable="false" sortable="false" rowsDisplayed="100" showPagination="false">
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLS_READ%>">
				<ec:exportXls fileName="Transaction Type Summary Report.xls" tooltip="Export Excel"/>
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLSX_READ%>">
				<ec:exportXlsx fileName="Transaction Type Summary Report.xlsx" tooltip="Export Excel" />
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
				<ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
					headerTitle="Transaction Type Summary Report" fileName="Transaction Type Summary Report.pdf" tooltip="Export PDF"/>
			</authz:authorize>
			<authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_CSV_READ%>">
				<ec:exportCsv fileName="Transaction Type Summary Report.csv" tooltip="Export CSV"></ec:exportCsv>
			</authz:authorize>	
			<ec:row>
				<ec:column property="productName" title="Transaction Type"/>
				<ec:column property="productId" title="No. of Transactions" format="0" calc="total" calcTitle="Total:" style="text-align: right"/>
