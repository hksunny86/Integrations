...
<head>
    ...
    <meta name="title" content="Merchant camping Discount Card Report" />
...
<html:form name='merchantCampingForm' commandName="MerchantCampingController" method="post"
           action="${contextPath}/p_merchantcampaing.html" onsubmit="return validateForm(this);" >
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input name="reset" type="reset"
                       onclick="javascript: window.location='p_merchantcampaing.html?actionId=${retriveAction}'"
...
<ec:table items="reqList" var="model"
          action="${contextPath}/p_merchantcampaing.html?actionId=${retriveAction}"
    ...
    <ec:row>
        ...
        <ec:column property="cardNo" title="Card No" escapeAutoFormat="true"/>
        ...
        <ec:column property="merchanName" title="Merchant Name" escapeAutoFormat="true"/>
        <ec:column property="segmentName" title="Segment Name" escapeAutoFormat="true"/>
        <ec:column property="status" title="Status Desc" escapeAutoFormat="true"/>
