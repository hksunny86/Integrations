...
<head>
    ...
    <meta name="title" content="My Authorization Requests"/>
...
<html:form name='extendedActionAuthorizationModelForm' commandName="extendedActionAuthorizationModel" method="post"
           action="p_myauthorizationrequests.html" onsubmit="return validateFormData(this)">
    <table width="100%" border="0">
        <tr>
            ...
            <td align="left" width="30%">
                <html:input path="actionAuthorizationId" id="actionAuthorizationId" cssClass="textBox" maxlength="50"
                            tabindex="1" onkeypress="return maskNumber(this,event)"/>
            </td>
        ...
        <tr>
            ...
            <td align="left">
                <html:input path="createdOnFromDate" id="createdOnFromDate" readonly="true" tabindex="-1"
            ...
            <td align="left">
                <html:input path="createdOnToDate" id="createdOnToDate" readonly="true" tabindex="-1" cssClass="textBox"
                            maxlength="10"/>
    ...
    <input type="hidden" name="myRequests" value="true">
</html:form>


<ec:table items="actionAuthorizationModellist" var="actionAuthorizationModel"
          action="${contextPath}/p_myauthorizationrequests.html"
          title="" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" filterable="false">
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLS_READ%>">
        <ec:exportXls fileName="My Authorization Requests.xls" tooltip="Export Excel"/>
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_XLSX_READ%>">
        <ec:exportXlsx fileName="My Authorization Requests.xlsx" tooltip="Export Excel"/>
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
        <ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
                      headerTitle="View Transactions"
                      fileName="My Authorization Requests.pdf" tooltip="Export PDF"/>
    </authz:authorize>
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_CSV_READ%>">
        <ec:exportCsv fileName="My Authorization Requests.csv" tooltip="Export CSV"></ec:exportCsv>
    </authz:authorize>
    ...
    <ec:row>
        ...
        <ec:column alias="" title="" style="text-align: center" sortable="false" viewsAllowed="html">
            <input type="button" class="button" value="View Detail"
                   name="ActionDetail${actionAuthorizationModel.actionAuthorizationId}"
                   onclick="openActionDetailWindow(${actionAuthorizationModel.actionAuthorizationId},${actionAuthorizationModel.usecaseId})"/>
        </ec:column>
