...
<head>
    ...
    <meta name="title" content="Vc File Summary Report"/>
...
<%--@elvariable id="SearchVcFileSummaryController" type=""--%>
<html:form name='vcfileSearchForm' commandName="vcFileSummaryController" method="post"
           action="${contextPath}/p_vcfileSummary.html" onsubmit="return validateForm(this);">
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input name="reset" type="reset"
                       onclick="javascript: window.location='p_vcfileSummary.html?actionId=${retriveAction}'"
...
<ec:table items="reqList" var="model"
          action="${contextPath}/p_vcfileSummary.html?actionId=${retriveAction}"
    ...
    <authz:authorize ifAnyGranted="<%=PortalConstants.PERMS_EXPORT_PDF_READ%>">
        <ec:exportPdf view="com.inov8.microbank.common.util.CustomPdfView" headerBackgroundColor="#b6c2da"
                      headerTitle="List Authorizations"
    ...
    <ec:row>
        ...
        <ec:column property="walletNumber" title="Wallet Number" escapeAutoFormat="true"/>
        <ec:column property="mobileNo" title="Mobile Number" escapeAutoFormat="true"/>
        <ec:column property="load" title="LOAD" escapeAutoFormat="true"/>
        <ec:column property="transactionDate" title="Transaction Date" escapeAutoFormat="true"/>
        <ec:column property="purchases" title="Purchases" escapeAutoFormat="true"/>
        <ec:column property="runBal" title="Running Balance" escapeAutoFormat="true"/>
