...
<meta name="title" content="Agent WHT Report 236-P" />
...
<body>
	...
	<html:form name="wHTSummaryForm" commandName="wHTSummaryViewModel" method="post" action="p_whtAgentCustReport236P.html"
	...
	<!-- data table result -->
	<ec:table items="resultList" var="model" action="${contextPath}/p_whtAgentCustReport236P.html" title="" retrieveRowsCallback="limit"
