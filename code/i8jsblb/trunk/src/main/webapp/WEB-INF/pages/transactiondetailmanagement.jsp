...
<tr class="tableHeader" style="padding: 0px;" >
	...
	<tr>
	<td width="40%" class="titleRow" style=" font-weight: bold; width: 117px;">Transaction Code</td>
...
<tr style="padding: 0px;">
	...
	<tr>
		...
		<tr>
		<td class="titleRow" style="text-align: left; font-weight: bold; width: 117px;">
		<c:if test="${not param.isMfs}">
		<c:out value="Agent ID"></c:out>
		</c:if>
		<c:if test="${param.isMfs}">
	...
	<tr>	
		...
		<c:if test="${param.isMfs}">
		<tr>
		<td class="titleRow" style="text-align: left; font-weight: bold; width: 117px;">Customer Mobile No</td>
		<td class="odd" style="font-family:verdana;font-size: 10px;"><c:out value="${transactionListViewModel.customerMobileNo}" /> </td>
		</tr>
		</c:if>	
