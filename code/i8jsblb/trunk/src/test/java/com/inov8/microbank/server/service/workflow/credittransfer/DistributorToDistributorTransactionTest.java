...
public class DistributorToDistributorTransactionTest extends BaseManagerIntegrationTestCase
{
	...
	public void testCreditTransfer() throws Exception
	{
		...
		workFlowWrapper.getTransactionTypeModel().setTransactionTypeId(TransactionTypeConstantsInterface.DIST_TO_DIST_TX);
		...
		workFlowWrapper.getToDistributorContactAppUserModel().setMobileNo("03344227165");
