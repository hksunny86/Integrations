...
public class DistributorToRetailerTransactionTest extends BaseManagerIntegrationTestCase
{
	...
	public void testCreditTransfer() throws Exception
	{
		...
		workFlowWrapper.setFromDistributorContactAppUserModel(this.appUserModel);
		workFlowWrapper.getTransactionTypeModel().setTransactionTypeId(TransactionTypeConstantsInterface.DIST_TO_RET_TX);
		workFlowWrapper.getDeviceTypeModel().setDeviceTypeId(DeviceTypeConstantsInterface.MOBILE);

		workFlowWrapper.setTransactionAmount(30D);
		workFlowWrapper.getToRetailerContactAppUserModel().setMobileNo("03344227165");
