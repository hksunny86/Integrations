...
public class I8SBConstants {
    ...
    public static String RequestType_ZINDIGI_UPDATE_ACCOUNT_STATUS="ZindigiUpdateAccountStatus";
    ...
    public static String RequestType_LENDING_OUTSTANDING_LOANREPAYMENT = "LendingOutStandinLoanRepayment";
