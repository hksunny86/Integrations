 ...
 *         &lt;element name="OriginalSTAN" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="CurrentTransactionDateTime" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="OriginalTransactionDateTime" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="OriginalTransmittionDateTime" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "originalTransmittionDateTime",
    "commission"
})
@XmlRootElement(name = "FTReversal")
public class FTReversal
    implements Serializable
{
    ...
    @XmlElement(name = "OriginalSTAN", nillable = true)
    protected String originalSTAN;
    @XmlElement(name = "CurrentTransactionDateTime", nillable = true)
    protected String currentTransactionDateTime;
    @XmlElement(name = "OriginalTransactionDateTime", nillable = true)
    protected String originalTransactionDateTime;
    @XmlElement(name = "OriginalTransmittionDateTime", nillable = true)
    protected String originalTransmittionDateTime;
    ...
    /**
     * Gets the value of the originalSTAN property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the originalSTAN property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setOriginalSTAN(String value) {
        this.originalSTAN = value;
    }

    /**
     * Gets the value of the currentTransactionDateTime property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getCurrentTransactionDateTime() {
        return currentTransactionDateTime;
    }

    /**
     * Sets the value of the currentTransactionDateTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCurrentTransactionDateTime(String value) {
        this.currentTransactionDateTime = value;
    }
    ...
    /**
     * Gets the value of the originalTransmittionDateTime property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getOriginalTransmittionDateTime() {
        return originalTransmittionDateTime;
    }

    /**
     * Sets the value of the originalTransmittionDateTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setOriginalTransmittionDateTime(String value) {
        this.originalTransmittionDateTime = value;
    }
