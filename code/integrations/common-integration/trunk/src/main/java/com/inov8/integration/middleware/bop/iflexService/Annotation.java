    ...
    implements Serializable
{
    ...
    protected List<Serializable> appinfosAndDocumentations;
     ...
     * 
     */
    public List<Serializable> getAppinfosAndDocumentations() {
        if (appinfosAndDocumentations == null) {
            appinfosAndDocumentations = new ArrayList<Serializable>();
        }
