    ...
    implements Serializable
{
    ...
    protected List<Serializable> uniquesAndKeiesAndKeyreves;
     ...
     * 
     */
    public List<Serializable> getUniquesAndKeiesAndKeyreves() {
        if (uniquesAndKeiesAndKeyreves == null) {
            uniquesAndKeiesAndKeyreves = new ArrayList<Serializable>();
        }
