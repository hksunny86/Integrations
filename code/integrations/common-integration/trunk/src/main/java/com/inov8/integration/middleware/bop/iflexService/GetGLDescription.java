...
@XmlRootElement(name = "GetGLDescription", namespace = "http://tempuri.org/")
public class GetGLDescription
    implements Serializable
{
    ...
    @XmlElement(name = "GLAccountNumber", namespace = "http://tempuri.org/", nillable = true)
