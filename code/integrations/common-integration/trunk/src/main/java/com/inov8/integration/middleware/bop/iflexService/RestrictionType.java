    ...
    implements Serializable
{
    ...
    protected List<Serializable> minExclusivesAndMinInclusivesAndMaxExclusives;
     ...
     * 
     */
    public List<Serializable> getMinExclusivesAndMinInclusivesAndMaxExclusives() {
        if (minExclusivesAndMinInclusivesAndMaxExclusives == null) {
            minExclusivesAndMinInclusivesAndMaxExclusives = new ArrayList<Serializable>();
        }
