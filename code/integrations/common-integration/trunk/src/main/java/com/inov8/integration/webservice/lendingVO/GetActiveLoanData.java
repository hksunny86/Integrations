...
public class GetActiveLoanData implements Serializable {
    ...
    private GetActiveLoanRequestPayload payLoad;
    ...
    public GetActiveLoanRequestPayload getPayLoad() {
        return payLoad;
    }

    public void setPayLoad(GetActiveLoanRequestPayload payLoad) {
