...
public class GetOutstandingData implements Serializable {
    ...
    private GetOutstandingRequestPayload payLoad;
    ...
    public GetOutstandingRequestPayload getPayLoad() {
        return payLoad;
    }

    public void setPayLoad(GetOutstandingRequestPayload payLoad) {
