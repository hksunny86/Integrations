package com.inov8.integration.lending.service;
...
import com.inov8.integration.lending.pdu.response.DebitBlockResponse;
import com.inov8.integration.thirdParty.pdu.response.ReferralAccountInfoResponse;
import com.inov8.integration.webservice.controller.LendingWebServiceSwitchController;
...
@Component
public class LendingHostIntegrationService {
    private static Logger logger = LoggerFactory.getLogger(LendingHostIntegrationService.class.getSimpleName());
    ...
    private static String I8_PATH = (ConfigReader.getInstance().getProperty("lending-i8-path", ""));
    ...
    private LendingWebServiceSwitchController switchController = null;


    public LendingHostIntegrationService() {
...
//	 */
    ...
    private void buildSwitch() {
        try {
            if (switchController == null) {
                ...
                httpInvokerProxyFactoryBean.setServiceInterface(LendingWebServiceSwitchController.class);
                ...
                switchController = (LendingWebServiceSwitchController) httpInvokerProxyFactoryBean.getObject();
            }
        } catch (Exception e) {
    ...
    public DebitBlockResponse debitBlockResponse(DebitBlockRequest request) {
        ...
        messageVO.setLienMark(request.getLienMark());
        messageVO.setLienAmount(request.getLienAmount());
        ...
        logModel.setTransactionCode("DebitBlock");
...
//        saveTransaction(logModel);
        ...
        // Call i8
        try {
            logger.info("[HOST] Sent Debit Block Request to Micro Bank " + I8_SCHEME + "://" + I8_SERVER + ":" + I8_PORT + I8_PATH + " against RRN: " + messageVO.getRetrievalReferenceNumber());

            messageVO = switchController.debitBlock(messageVO);
        } catch (Exception e) {
        ...
        if (messageVO != null
            ...
            logger.info("[HOST] Debit Block Request Successful from Micro Bank RRN: " + messageVO.getRetrievalReferenceNumber());
            ...
            logger.info("[HOST] Debit Block Request Unsuccessful from Micro Bank RRN: " + messageVO.getRetrievalReferenceNumber());
        ...
        logger.debug("[HOST] **** Debit Block Request PROCESSED IN ****: " + difference + " milliseconds");

        //preparing request
        String responseXml = JSONUtil.getJSON(response);
        logger.info("[HOST] ****Debit Block Response" + Objects.requireNonNull(responseXml).replaceAll(System.getProperty("line.separator"), " "));
        //Setting in logModel
