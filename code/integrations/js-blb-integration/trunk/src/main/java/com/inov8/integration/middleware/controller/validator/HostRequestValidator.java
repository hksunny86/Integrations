...
//        }
    ...
    public static void validateCheckLoan(CheckLoanRequest integrationVO) throws ValidationException {
    ...
    public static void validateDeviceUpdate(DeviceUpdateRequest integrationVO) throws ValidationException {
