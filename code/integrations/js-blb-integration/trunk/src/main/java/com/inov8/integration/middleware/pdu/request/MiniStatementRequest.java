...
@XmlRootElement(name = "MiniStatementRequest")
public class MiniStatementRequest implements Serializable{

    private static final long serialVersionUID = -3931449162880989821L;
