...
public class UpgradeMinorAccountInquiryRequest implements Serializable {
    ...
    @JsonProperty("SnicBackPic")
    private String snicBackPic;
    @JsonProperty("ParentNicBackPic")
    ...
    public void setParentnicBackPic(String parentnicBackPic) {
        this.parentnicBackPic = parentnicBackPic;
    }
