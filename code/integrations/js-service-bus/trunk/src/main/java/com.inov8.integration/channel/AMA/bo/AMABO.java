package com.inov8.integration.channel.AMA.bo;

import com.inov8.integration.channel.AMA.request.Request;
import com.inov8.integration.channel.AMA.request.UpdateAmaRequest;
import com.inov8.integration.channel.AMA.response.Response;
import com.inov8.integration.channel.AMA.response.UpdateAmaResponse;
import com.inov8.integration.channel.AMA.service.AmaService;
...
@Component
public class AMABO  implements I8SBChannelInterface {
    private static Logger logger = LoggerFactory.getLogger(AMABO.class.getSimpleName());
    @Autowired
    ...
    public I8SBSwitchControllerResponseVO execute(I8SBSwitchControllerRequestVO i8SBSwitchControllerRequestVO) throws Exception {
        ...
        com.inov8.integration.channel.AMA.request.Request request = null;
        com.inov8.integration.channel.AMA.response.Response response = null;
        if (objects[0] != null) {
        ...
        if (request.validateRequest()) {
            ...
            if (requestType.equalsIgnoreCase(I8SBConstants.RequestType_AMMA_Update_Account)) {
                response = amaService.updateAmaResponse((UpdateAmaRequest) request);
            }
    ...
    private Object[] initializeRequestAndResponseObjects(String requestType) {
        ...
        if (requestType.equalsIgnoreCase(I8SBConstants.RequestType_AMMA_Update_Account)) {
            request = new UpdateAmaRequest();
            response = new UpdateAmaResponse();
        } else {
