...
public class CardIssuanceReissuanceRequest extends Request {
    ...
    public boolean validateRequest() throws I8SBValidationException {
        ...
        if (StringUtils.isEmpty(this.getFingerIndex())){
            throw new I8SBValidationException("[Failed] Finger Index" + this.getFingerIndex());

        }
        if (StringUtils.isEmpty(this.getFingerTemplate())){
            throw new I8SBValidationException("[Failed] Finger Template" + this.getFingerTemplate());
