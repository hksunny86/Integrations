...
//            httpConduit.setTlsClientParameters(tlsCP);
            ...
            headers.put("Access_Token", bearerToken);
//            headers.put("Authorization", "Bearer " + bearerToken);
            postParam.put("ProcessingCode", request.getProcessingCode());
            postParam.put("TransmissionDatetime", request.getTransmissionDatetime());
            postParam.put("SystemsTraceAuditNumber", request.getSystemsTraceAuditNumber());
            postParam.put("TimeLocalTransaction", request.getTimeLocalTransaction());
            postParam.put("DateLocalTransaction", request.getDateLocalTransaction());
            postParam.put("MerchantType", request.getMerchantType());
            postParam.put("Cnic", request.getCnic());
            postParam.put("CustomerName", request.getCustomerName());
            ...
            postParam.put("CustomerNumber", request.getCustomerNumber());
