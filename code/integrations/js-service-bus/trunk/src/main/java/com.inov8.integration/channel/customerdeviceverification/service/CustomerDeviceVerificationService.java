...
public class CustomerDeviceVerificationService {
    ...
    public CustomerDeviceVerificationResponse customerDeviceVerificationResponse(CustomerDeviceVerificationRequest request) throws Exception {
        ...
        if (this.i8sb_target_environment != null && this.i8sb_target_environment.equalsIgnoreCase("mock")) {
            ...
            String response = mock.customerDeviceDetails();
            ...
            Objects.requireNonNull(customerDeviceVerificationResponse).setResponseCode("00");
            ...
            try {
                ...
                ResponseEntity<String> res = getRestTemplate().postForEntity(uri.build().toUri(), httpEntity, String.class);
...
//        RestTemplate restTemplate = new RestTemplate();
//        CustomerDeviceVerificationRequest request = new CustomerDeviceVerificationRequest();
//        CustomerDeviceVerificationResponse customerDeviceVerificationResponse = new CustomerDeviceVerificationResponse();
//        request.setMobileNo("03028563561");
//        try {
//            {
//                logger.info("Refferal Customer " + "https://zindigi-andriod.jsbl.com:8443/api/Zindigi/CustomerAuthenticationStatus");
//                UriComponentsBuilder uri = UriComponentsBuilder.fromUriString("https://zindigi-andriod.jsbl.com:8443/api/Zindigi/CustomerAuthenticationStatus");
//                HttpHeaders headers = new HttpHeaders();
//                headers.setContentType(MediaType.APPLICATION_JSON);
//                headers.add("Access_token", "$81*4A&d3L@!");
//                String requesJson = JSONUtil.getJSON(request);
//                logger.info("Request Send To Get Customer Device Verification List:" + requesJson);
//                HttpEntity<?> httpEntity = new HttpEntity<>(requesJson, headers);
//
