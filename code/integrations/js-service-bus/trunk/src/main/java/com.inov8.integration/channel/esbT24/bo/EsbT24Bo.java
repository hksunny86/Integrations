package com.inov8.integration.channel.esbT24.bo;

import com.inov8.integration.channel.esbT24.request.Request;
import com.inov8.integration.channel.esbT24.request.TransactionRequest;
import com.inov8.integration.channel.esbT24.response.Response;
import com.inov8.integration.channel.esbT24.response.TransactionResponse;
import com.inov8.integration.channel.esbT24.service.EsbT24Service;
...
@Component
public class EsbT24Bo implements I8SBChannelInterface {

    @Autowired
    EsbT24Service esbT24Service;
    private static Logger logger = LoggerFactory.getLogger(EsbT24Bo.class.getSimpleName());
    ...
    public I8SBSwitchControllerResponseVO execute(I8SBSwitchControllerRequestVO i8SBSwitchControllerRequestVO) throws Exception {
        ...
        if (request.validateRequest()) {
            ...
            esbT24Service.setI8SBSwitchControllerRequestVO(i8SBSwitchControllerRequestVO);
            if (requestType.equalsIgnoreCase(I8SBConstants.RequestType_ESBT24_TRANSACTION)) {
                response = esbT24Service.transactionResponse((TransactionRequest) request);
            }
