...
public class DeleteAliasResponse extends Response implements Serializable {

    @JsonProperty("Response")
    private DelAlias response;
    ...
    @JsonProperty("Response")
    public DelAlias getResponse() {
        return response;
    }

    @JsonProperty("Response")
    public void setResponse(DelAlias response) {
