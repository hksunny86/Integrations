package com.inov8.integration.channel.warmbyte.bo;
...
@Component
public class WarmByteBo implements I8SBChannelInterface {

    @Autowired
    WarmbyteService warmbyteService;
    private static Logger logger = LoggerFactory.getLogger(WarmByteBo.class.getSimpleName());
