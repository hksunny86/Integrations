...
public class WasaService {
    ...
    public WasaLoginResponse wasaLoginResponse(WasaLoginRequest wasaLoginRequest) {
        ...
        if (this.i8sb_target_environment != null && this.i8sb_target_environment.equalsIgnoreCase("mock5")) {
            ...
            map.add("username",wasaLoginRequest.getUsername());
            map.add("password",wasaLoginRequest.getPassword());
            map.add("ipaddress",wasaLoginRequest.getIpaddress());
            map.add("grant_type",wasaLoginRequest.getGrantType());
...
//            HttpEntity<?> httpEntity = new HttpEntity(requestJSON, headers);
            ...
            try {
                ...
                logger.info("Wasa Login Request Sent to Client " + httpEntity.getBody().toString());
    ...
    public WasaGetBillResponse wasaGetBillResponse(WasaGetBillRequest wasaGetBillRequest) {
        ...
        if (this.i8sb_target_environment != null && this.i8sb_target_environment.equalsIgnoreCase("mock5")) {
            ...
            headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
            MultiValueMap<String, String> map= new LinkedMultiValueMap<String, String>();
            map.add("consumerNum",wasaGetBillRequest.getConsumerNum());
...
//            HttpEntity<?> httpEntity = new HttpEntity(requestJSON, headers);
    ...
    public WasaPostBillResponse wasaPostBillResponse(WasaPostBillRequest wasaPostBillRequest) {
        ...
        if (this.i8sb_target_environment != null && this.i8sb_target_environment.equalsIgnoreCase("mock5")) {
            ...
            headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
            MultiValueMap<String, String> map= new LinkedMultiValueMap<String, String>();
            map.add("consumerNum",wasaPostBillRequest.getConsumerNum());
            map.add("amount",wasaPostBillRequest.getAmount());
            map.add("consumer_cell",wasaPostBillRequest.getConsumerCell());
            map.add("transactionID",wasaPostBillRequest.getTransactionId());
            headers.add("Authorization", "Bearer " + accessToken);
...
//            HttpEntity<?> httpEntity = new HttpEntity(requestJSON, headers);
    ...
    public WasaLogoutResponse wasaLogoutResponse(WasaLogoutRequest wasaLogoutRequest) {
        ...
        if (this.i8sb_target_environment != null && this.i8sb_target_environment.equalsIgnoreCase("mock5")) {
            ...
            headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
            MultiValueMap<String, String> map= new LinkedMultiValueMap<String, String>();
            map.add("Token",wasaLogoutRequest.getToken());
            headers.add("Authorization", "Bearer " + accessToken);
