...
public class JazzTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(JazzTest.class.getSimpleName());
    ...
    public void sendSms() {
        ...
        requestVO.setI8sbChannelID(I8SBConstants.I8SB_Channel_ID_JAZZ);
        requestVO.setRequestType(I8SBConstants.RequestType_JAZZ_SEND_SMS);

        requestVO.setMobileNumber("03314458547");
        requestVO.setSmsText("Samosa ksa ha?");
