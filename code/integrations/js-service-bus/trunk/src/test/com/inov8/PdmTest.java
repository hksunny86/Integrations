...
public class PdmTest {
    private static Logger logger = LoggerFactory.getLogger(PdmTest.class.getSimpleName());
    ...
    public void sendInitiateLoan() {
        ...
        requestVO.setI8sbChannelID(I8SBConstants.I8SB_Channel_ID_PDM);
        requestVO.setRequestType(I8SBConstants.RequestType_PDM_Validate);

        requestVO.setMobileNumber("03164989069");
        requestVO.setCNIC("3120215012399");
