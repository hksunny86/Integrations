...
public class MiddlewareRequestEncoder implements ProtocolEncoder {
	private static Logger logger = LoggerFactory.getLogger(MiddlewareRequestEncoder.class.getSimpleName());
	...
	public void encode(IoSession session, Object message, ProtocolEncoderOutput out) throws Exception {
		...
		logger.debug("Encoded Request Bytes Length: " + pdu.getRawPdu().length);
		logger.debug("######### REQUEST HEX DUMP ############### " + buffer.getHexDump());
		logger.debug("REQUEST STRING ASCII: " + pdu.getRawPdu());
		logger.debug("REQUEST STRING HEX: " + Hex.encodeHexString(metaLengthBytes) + Hex.encodeHexString(pdu.getRawPdu()));
