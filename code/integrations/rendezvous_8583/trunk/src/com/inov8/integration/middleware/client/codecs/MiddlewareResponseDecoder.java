...
public class MiddlewareResponseDecoder extends CumulativeProtocolDecoder {

	private final Logger logger = LoggerFactory.getLogger(getClass().getSimpleName());
	private static final String DECODER_STATE_KEY = MiddlewareResponseDecoder.class.getName() + ".STATE";
