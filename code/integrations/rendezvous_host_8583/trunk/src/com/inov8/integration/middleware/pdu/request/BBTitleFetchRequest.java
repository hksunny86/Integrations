...
public class BBTitleFetchRequest extends BasePDU {

	private static final long serialVersionUID = -6315654173752464645L;

	public BBTitleFetchRequest(){
		if(getHeader() == null){
			this.setHeader(new BaseHeader());
			this.getHeader().setMessageType("0200");
			this.setProcessingCode(TransactionCodeEnum.JS_BB_TITLE_FETCH.getValue());
		}
