...
public class BillPaymentRequest extends BasePDU {

	private static final long serialVersionUID = 2329184579077064385L;
	...
	public void assemble() {
		...
		try {
			...
			msg.set(SETTLEMENT_AMOUNT_PROCESSING_FEE.getValue(), trimToEmpty(getSettlementProcessingFee()));
