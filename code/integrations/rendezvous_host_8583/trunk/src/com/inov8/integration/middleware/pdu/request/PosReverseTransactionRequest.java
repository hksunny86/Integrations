...
import static com.inov8.integration.middleware.enums.ISO8583FieldEnum.POS_ENTRY_MODE;
...
import static com.inov8.integration.middleware.enums.ISO8583FieldEnum.TRACK_2_DATA;
...
public class PosReverseTransactionRequest extends BasePDU {
	
	 public PosReverseTransactionRequest() {
	        this.setHeader(new BaseHeader());
	        this.getHeader().setMessageType("0200");
	        this.setProcessingCode(TransactionCodeEnum.JS_BB_POS_REVERSAL.getValue());
	    }
